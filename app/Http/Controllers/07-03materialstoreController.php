...
//$select_search = 'importId';
                ...
                $withdrawmaterial = Materialstore::where('supplierName', 'LIKE', '%' . $request->supId . '%')->get();
                //print($request->supId);
                $select_search = 'supId';
                //print(count($withdrawmaterial));
            } elseif ($request->filled('yarnType')) {
                $withdrawmaterial = Materialstore::where('yarnType', 'LIKE', '%' . $request->yarnType . '%')->get();
                //print($request->yarnType );
                $select_search = 'yarnType';
            } elseif ($request->filled('imDate')) {
                $withdrawmaterial = Materialstore::where('createDate', 'LIKE', '%' . $request->imDate . '%')->get();
