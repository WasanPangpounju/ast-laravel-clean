...
class FabricoutController extends Controller
{
    ...
    public function index()
    {
        ...
        $records = fabricout::groupBy(['vatType','vatNo','fabricStruct', 'no', 'refId', 'customerName', 'receiveName', 'fabricPattern', 'fabricW'])
            ->selectRaw('vatNo,vatType,fabricStruct,fabricPattern,fabricW,receiveName,no, customerName, COUNT(fold) as foldCount, SUM(sumYard) as sumYardSum, MAX(createDate) as lastDate')
