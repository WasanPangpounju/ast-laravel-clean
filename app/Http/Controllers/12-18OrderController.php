    ...
    public function store(Request $request)
    {
        ...
        if (($request->filled('submit') && $request->submit == 'purchaseorder') || ($request->filled('submit') && $request->submit == 'production')) {
            ...
            if ($vat == 'SOX') {
                ...
                $this->fpdf->MultiCell(70, $row_height, iconv('UTF-8', 'cp874', $comment . ' ' . ' ราคานี้รวม VAT แล้ว'), 0, 0);
            } else {
                if ($po != 'no data') {
                    $this->fpdf->MultiCell(70, $row_height, iconv('UTF-8', 'cp874', $comment . ' ' . $po), 0, 0);
                } else {
                    $this->fpdf->MultiCell(70, $row_height, iconv('UTF-8', 'cp874', $comment), 0, 0);
                }
            }
