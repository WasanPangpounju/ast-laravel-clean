    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('submit') && $request->submit == 'searchImport') {
            ...
            if ($request->filled('importId') && $request->filled('customerName') && $request->filled('yarnType') && $request->filled('imDate')) {
                ...
                $importorder = AstPurchaseorder::where('createDate', 'LIKE', '%' . $request->imDate . '%')->get();
            ...
            // print_r($importorder);
            return view('orders.index', compact('importorder', 'select_search', 'searchInput','orderlist'));
        }
                ...
                if ($orderEdit) {
                    ...
                    if ($fabricStructureEdit) {
                        ...
                        if ($request->submit == 'productionderdetailPdf') {
                            return view('orders.showproductionpdf', compact('showproduction', 'fabricStructureData'));
                        } else {
