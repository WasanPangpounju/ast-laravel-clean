                        ...
                        <form method="post" action="{{ route('fabricout.store') }}">
                            ...
                            <div class="line_btn_search">
                                ...
                                <button type="submit" name="back" value="searchImport" class="btn_search"><i
                                        class="fa fa-search"></i><a href="{{ route('fabricout.index') }}"
                                        style="color: white"> กลับค่าหลัก</a></button>
                            </div>
                                ...
                                <tbody style="text-align: right;">
                                    ...
                                    @for ($i = 0; $i < $c; $i++)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('fabricout.store') }}" method="get"
                                                    target="_blank">
                                                    @csrf
                                                    <input type="hidden" name="fabricout_no"
                                                    ...
                                                    {{-- <input type="text" value="{{ $sumfabricout[$i]->refId }}"
                                                        name="refId">
                                                    <button class="btn b_order" type="submit" name="editfabricout"
                                                        style="width:90%;margin: 0.2rem;font-size: 0.8rem">แก้ไข</button> --}}
                                                </form>
                                            </td>
                                            <td>
                                                <form method="POST"
                                                    ...
                                                    <div style="margin: 0.2rem">
                                                        ...
                                                        <button class="btn b_order" type="button"
                                                            style="width:90%;margin: 0.2rem;font-size: 0.8rem"><a
                                                                href="{{ route('fabricout.edit', $sumfabricout[$i]->refId) }}">แก้ไข</a></button>
                                                    </div>
                                                </form>
                                                {{-- <form method="GET" action="{{ route('fabricout.store') }}">
                                                    @csrf
                                                    <input type="text" value="{{ $sumfabricout[$i]->refId }}"
                                                        name="refId">
                                                    <button class="btn b_order" type="submit" name="editfabricout"
