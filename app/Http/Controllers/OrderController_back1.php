...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('submit') && $request->submit == 'generateproduction') {
            ...
            $fixedorderSumYard = str_replace(',', '', $validatedData['orderSumYard'] ?? '0');
            $fixedorderSumM = str_replace(',', '', $validatedData['orderSumM'] ?? '0');
            $fixedfabricSPY = str_replace(',', '', $validatedData['fabricSPY'] ??  '0');
            // $fixedpriceYard = str_replace(',', '', $validatedData['priceYard'] ?? '0');
            // $fixedpriceM = str_replace(',', '', $validatedData['priceM'] ?? '0');
            // $fixeddiscountYard = str_replace(',', '', $validatedData['discountYard'] ?? '0');
            // $fixeddiscountP = str_replace(',', '', $validatedData['discountP'] ?? '0');
            ...
            // $validatedData['discountYard'] = $fixeddiscountYard ?? '0';
