            ...
            <div class="content">
                <div class="box-from">
                    ...
                    <form onsubmit="createFabricStructure()" method="post"
                        action="<?php echo e(route('order.store', $orderEdit->id)); ?>">
                        <?php echo csrf_field(); ?>

                        <input type="hidden" id="refId" name="refId" value="<?php echo e($orderEdit->id); ?>">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="date form-control" type="text" name="createDate" autocomplete="off"
                                            value="<?php echo e($flipped_date = date('d/m/Y', strtotime($orderEdit->createDate))); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="yarn_h_count" class="form-control" id="yarn_h_count"
                                        ...
                                        value="<?php echo e($fabricpaymentEdit[0]->yarn_h_count); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="typemachine" class="form-control" id="typemachine"
                                        placeholder="" value="<?php echo e($orderEdit->typemachine); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="machinenumber" class="form-control" id="machinenumber"
                                        placeholder="" value="<?php echo e($orderEdit->machinenumber); ?>">
                                </div>
                            </div>
                        </div>
                        <!--row-->
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/orders/production.blade.php ENDPATH**/ ?>