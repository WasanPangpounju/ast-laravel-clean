    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="box-from">
                ...
                <form method="post" action="<?php echo e(route('fabricout.store')); ?>" id="myForm">
                    <?php echo csrf_field(); ?>
                        ...
                        print(' <b>หมายเหตุ : </b>'. $comment .'<br>');
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $FabricOutEdit2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $FOutEdit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        
                                        <input class="date form-control" type="text" name="dt" value="<?php echo e($FOutEdit->createDate); ?>"
                                            autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <input type="text" name="fabricStruct"
                                            onkeyup="supplierFunction('fabricStruct')" class="form-control"
                                            id="fabricStruct" placeholder="โครงสร้างผ้า" value="<?php echo e($FOutEdit->fabricStruct); ?>"
                                            required>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <?php else: ?>
                                                <input type="text" name="fabricPattern" class="form-control"
                                                    id="fabricPattern" placeholder="ลายผ้า" value="<?php echo e($FOutEdit->fabricPattern); ?>"
                                                    required>
                                            <?php endif; ?>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <?php else: ?>
                                                <input type="text" name="fabricW" class="form-control"
                                                    id="fabricW"placeholder="หน้ากว้าง" value="<?php echo e($FOutEdit->fabricW); ?>"
                                                    required>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <input type="text" name="customerName" class="form-control" id="myInput"
                                            onkeyup="myFunction()" placeholder="ผู้สั่ง" value="<?php echo e($FOutEdit->customerName); ?>"
                                            required>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <input type="text" name="receiveName" class="form-control" id="receiveName"
                                            placeholder="ผู้รับ" value="<?php echo e($FOutEdit->receiveName); ?>" required>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <input type="text" name="fabricStructReplace" class="form-control"
                                            id="fabricStructReplace" placeholder="แทนโครงสร้างผ้า"
                                            value="<?php echo e($FOutEdit->fabricStructReplace); ?>">
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <input type="text" name="customerReplace" class="form-control"
                                            id="customerReplace" placeholder="แทนผู้สั่งซื้อ"
                                            value="<?php echo e($FOutEdit->customerReplace); ?>">
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/fabricout/edit.blade.php ENDPATH**/ ?>