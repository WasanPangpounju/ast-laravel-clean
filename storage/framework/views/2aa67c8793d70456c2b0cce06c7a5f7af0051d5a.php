    ...
    <div class="content-wrapper">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">เบิกวัตถุดิบ</a></li>
                <li class="breadcrumb-item active">ตรวจสอบเบิกวัตถุดิบ</li>
            </ol>
        </div>
        ...
        <div class="content">
            <div class="box-from">
                            ...
                            <table class="table table-bordered table-a">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2">จำนวน<br>กระดาษกั้น</th>
                                ...
                                <tbody>
									...
									<tr>
										<td>ผู้รับวัตถุดิบ</td>
										<td><?php echo e($imdata->recipient); ?></td>
									</tr>
									<tr>
										<td>การนำไปใช้</td>
										<td><?php echo e($imdata->comment); ?></td>
									</tr>
                                    <tr>
										<td>หมายเหตุ</td>
										<td><?php echo e($imdata->paymentComment); ?></td>
									</tr>
                ...
                <form method="post" action="<?php echo e(route('materialoutside.store')); ?>">
                    ...
                    <input type="hidden" id="partition" name="partition" value="<?php echo e($imdata->partition); ?>">

                    <input type="hidden" id="pallet_type" name="pallet_type" value="<?php echo e($imdata->pallet_type); ?>">
                    <input type="hidden" id="box_type" name="box_type" value="<?php echo e($imdata->box_type); ?>">
                    <input type="hidden" id="sack_type" name="sack_type" value="<?php echo e($imdata->sack_type); ?>">
                    <input type="hidden" id="spool_type" name="spool_type" value="<?php echo e($imdata->spool_type); ?>">
                    ...
                    <input type="hidden" id="weight_p_package" name="weight_p_package"
                        value="<?php echo e($imdata->weight_p_package); ?>">
                    <input type="hidden" id="weight_kg_package" name="weight_kg_package"
                        value="<?php echo e($imdata->weight_kg_package); ?>">
                    ...
                    <input type="hidden" id="packaging5" name="packaging5" value="<?php echo e($imdata->packaging5); ?>">

					<input type="hidden" id="recipient" name="recipient" value="<?php echo e($imdata->recipient); ?>">
                    <input type="hidden" id="comment" name="comment" value="<?php echo e($imdata->comment); ?>">

                    <input type="hidden" id="paymentComment" name="paymentComment" value="<?php echo e($imdata->paymentComment); ?>">


                    <div class="line_btn">
                        <button name="submit" value="back" class="btn b_order"><i
                                class="nav-icon fa fa-chevron-left"></i> ย้อนกลับ</button>
                        <button name="submit" value="save" class="btn b_save"><i class="nav-icon fas fa-save"></i>
                            บันทึก</button>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/materialoutside/checkwithdraw.blade.php ENDPATH**/ ?>