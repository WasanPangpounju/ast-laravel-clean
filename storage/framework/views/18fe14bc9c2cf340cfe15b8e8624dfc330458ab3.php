            ...
            <div class="content">
                <div class="box-from">
                    ...
                    <div class="date_order"><strong>วันที่
                        </strong><?php echo date('d/m/Y'); ?><span><strong>NO.</strong><?php echo e($last + 1); ?></span></div>

                    <form onsubmit="createFabricStructure()" method="post" action="<?php echo e(route('order.store')); ?>"
                        id="myForm">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="purchaseOrder" class="form-control" id="purchaseOrder"
                                        placeholder="เลขที่ใบสั่งซื้อ" value="<?php echo e($so); ?>" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/orders/create.blade.php ENDPATH**/ ?>