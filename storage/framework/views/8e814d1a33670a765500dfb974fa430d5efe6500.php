                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">
                            <p><?php echo e(Auth::user()->name); ?></p><?php echo e(Auth::user()->user_type); ?>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('customer.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>ข้อมูลลูกค้า</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('supplier.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>ข้อมูลซัพพลายเออร์</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('order.create')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>ใบคำสั่งขาย</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('inventory.create')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>คีย์ผ้าเข้าสต็อก</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('fabricout.create')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>เปิดบิลผ้า</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('fabricout.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>พิมพ์บิลส่งของ</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('fabriccheck.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>ตรวจสอบคีย์ผ้าเข้าสต็อก</p>
                                    </a>
                                </li>
                                                                <li class="nav-item">
                                    <a href="<?php echo e(route('inventory.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>ออร์เดอร์ลูกค้า</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('stockfabric.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>สต็อกผ้า</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('fabricdeposit.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('material.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>ตรวจสอบนำเข้าวัตถุดิบ</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('materialstore.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>ตรวจสอบเบิกวัตถุดิบออกภายใน</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('materialoutside.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>ตรวจสอบเบิกวัตถุดิบออกภายนอก</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('material.create')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>นำเข้าวัตถุดิบ</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('materialoutside.create')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>เบิกวัตถุดิบออกภายนอก</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('materialstore.create')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>เบิกวัตถุดิบออกภายใน</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('package.index')); ?>" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>คืนบรรจุภัณฑ์</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"><a href="<?php echo e(route('materialstock.index')); ?>"
...
<?php /**PATH /var/www/html/ast-menufacturing/resources/views/layouts/astmanufacturing.blade.php ENDPATH**/ ?>