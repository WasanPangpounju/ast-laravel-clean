				    ...
				    <div class="List_table">
					   <div class="row">
						  ...
						  <table class="table table-bordered table-a">
							...
							<tbody>
<?php $__currentLoopData = $withdrawmaterial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawmaterial1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
                            <td rowspan=“10”><?php echo e($date = date('d/m/Y', strtotime($withdrawmaterial1->createDate))); ?></td>
							  <td><?php echo e($withdrawmaterial1->supplierName); ?></td>
							  <td><?php echo e($withdrawmaterial1->emp); ?></td>
							  <td><?php echo e($withdrawmaterial1->yarnType); ?></td>

							  <td><?php echo e($withdrawmaterial1->lot); ?></td>

							  <td><?php echo e($withdrawmaterial1->spool); ?></td>
							  <td><?php echo e($withdrawmaterial1->weight_p_net); ?></td>
							  <td><?php echo e($withdrawmaterial1->weight_kg_net); ?></td>
							  <td><?php echo e($withdrawmaterial1->average_p); ?></td>
							  <td><?php echo e($withdrawmaterial1->average_kg); ?></td>
							  <td>
								<form method="POST" action="<?php echo e(route('materialstore.destroy', $withdrawmaterial1->id)); ?>">
									<?php echo csrf_field(); ?>
									<?php echo method_field('DELETE'); ?>
									<div style="  display: flex;justify-content: center;align-items: center;">
										<button class="btn btn-danger" type="button" onclick="if(confirm('ต้องการลบหรือไม่?')) { this.form.submit(); }" >ลบ</button>
										<button class="btn b_order" type="button" ><a href="<?php echo e(route('materialstore.edit',$withdrawmaterial1->id)); ?>">แก้ไข</a></button>
									</div>
								</form>
							   </td>
							</tr>
...
<div class="List_table">
					   <div class="row">
						  ...
						  <table class="table table-bordered table-a">
							...
							<?php $__currentLoopData = $lastTenRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawmaterial1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
                            <td rowspan=“10”><?php echo e($date = date('d/m/Y', strtotime($withdrawmaterial1->createDate))); ?></td>
							  <td><?php echo e($withdrawmaterial1->supplierName); ?></td>
							  <td><?php echo e($withdrawmaterial1->emp); ?></td>
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/materialstore/index.blade.php ENDPATH**/ ?>