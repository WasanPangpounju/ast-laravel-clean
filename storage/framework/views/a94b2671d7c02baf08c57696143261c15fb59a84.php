	...
	<div class="content-wrapper">
		...
		<div class="content">
			<div class="box-from">
			  ...
			  <form method="post" action="<?php echo e(route('materialstore.update',$dataEdit->id)); ?>">
        <?php echo method_field('PATCH'); ?>
			  <?php echo csrf_field(); ?>
                ...
                <option selected><?php echo e($dataEdit->department); ?></option>
...
?>
              ...
              <option selected><?php echo e($dataEdit->emp); ?></option>
				  ...
				  <div class="row" id="listwithdraw">
					  ...
					  <div class="col-md-3">
						   <div class="form-group">
							...
							<input type="text" name ="supplierName" onkeyup="supplierFunction('supId')" class="form-control" id="supId" placeholder="บริษัท" value="<?php echo e($dataEdit->supplierName); ?>" required >
...
?>
					...
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					  ...
					  <div class="col-md-3">
						   <div class="form-group">
							...
							<input type="text" name="spool" class="form-control" id="spool" placeholder="จำนวน" value="<?php echo e($dataEdit->spool); ?>" required >
						   </div>
					  </div>
          ...
          <div class="col align-self-center">
              ...
              <select name="lot" class="form-control">
                <option><?php echo e($dataEdit->lot); ?></option>
              </select>
          ...
          <div class="col-md-2">
						<div class="form-group">
							...
							<?php if(isset($dataEdit)): ?>
								<input type="text" name="weight_p_net" class="form-control" id="weight_p_net" placeholder="น้ำหนักสุทธิ(ปอนด์)" value="<?php echo e($dataEdit->weight_p_net); ?>">
							<?php else: ?>
          ...
          <div class="col-md-2">
						<div class="form-group">
							...
							<?php if(isset($dataEdit)): ?>
								<input type="text" name="weight_kg_net" class="form-control" id="weight_kg_net" placeholder="น้ำหนักสุทธิ(กิโลกรัม)" value="<?php echo e($dataEdit->weight_kg_net); ?>">
							<?php else: ?>
          ...
          <div class="col-md-2">
						<div class="form-group">
							...
							<?php if(isset($dataEdit)): ?>
								<input type="text" name="average_p" class="form-control" id="average_p" placeholder="น้ำหนักเฉลี่ย(กิโลกรัม)" value="<?php echo e($dataEdit->average_p); ?>">
							<?php else: ?>
          ...
          <div class="col-md-2">
						<div class="form-group">
							...
							<?php if(isset($dataEdit)): ?>
								<input type="text" name="average_kg" class="form-control" id="average_kg" placeholder="น้ำหนักเฉลี่ย(กิโลกรัม)" value="<?php echo e($dataEdit->average_kg); ?>">
							<?php else: ?>
            ...
            <button type="button" id="add" class="btn btn-etc"> <i class="fas fa-folder"></i> เพิ่มรายการใหม่</button>
				...
				<div class="line_btn">
					<button type="button" onclick="cleanform()" class="btn btn-danger"><a href="<?php echo e(route('materialstore.index')); ?>" style="color: white;"><img src="<?php echo asset('assets/images/xmark-solid.png'); ?>" width="15"> ยกเลิก</a></button>
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/materialstore/edit.blade.php ENDPATH**/ ?>