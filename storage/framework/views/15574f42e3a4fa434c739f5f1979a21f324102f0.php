...
<?php $__env->startSection('content'); ?>
            ...
            <div class="content">
                <div class="box-from">
                    ...
                    <div class="date_order"><strong>สร้างเมื่อ
                        </strong><?php echo e(date('l, j F Y H:i A', strtotime($productionEdit[0]->created_at))); ?><span><strong></strong></span>
                    </div>

                    <form onsubmit="createFabricStructure()" method="post"
                        action="<?php echo e(route('order.update', $productionEdit[0]->id)); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
                        <input type="hidden" id="refId" name="refId" value="<?php echo e($productionEdit[0]->refId); ?>">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="date form-control" type="text" name="createDate"
                                            value="<?php echo e($flipped_date = date('d/m/Y', strtotime(str_replace('/', '-', $productionEdit[0]->createDate)))); ?>"
                                            autocomplete="off">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customerName" class="form-control" id="myInput"
                                        ...
                                        value="<?php echo e($productionEdit[0]->customerName); ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="coname" class="form-control" id="coname"
                                        placeholder="ชื่อผู้ประสานงาน" value="<?php echo e($productionEdit[0]->deadline); ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fabricId" class="form-control" id="fabricId"
                                        placeholder="รหัสผ้า" value="<?php echo e($productionEdit[0]->fabricId); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fabricPattern" class="form-control" id="fabricPattern"
                                        placeholder="ลายผ้า" value="<?php echo e($productionEdit[0]->fabricPattern); ?>" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fabricStructure" class="form-control"
                                        ...
                                        value="<?php echo e($productionEdit[0]->fabricStructure); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="yarn_h_count" class="form-control" id="yarn_h_count"
                                        ...
                                        value="<?php echo e($productionEdit[0]->yarn_h_count); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fabric_w" class="form-control" id="fabric_w"
                                        placeholder="หน้าผ้า (นิ้ว)" value="<?php echo e($productionEdit[0]->fabric_w); ?>"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHType1" onkeyup="yarntypeFunction('yarnHType1' , 0)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->yarnHType1); ?>" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameH1" onkeyup="supplierFunction('subNameH1' , 0)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->subNameH1); ?>" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHCount1" class="form-control" id="yarnHCount1"
                                        placeholder="" value="<?php echo e($productionEdit[0]->yarnHCount1); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHRatio1" class="form-control" id="yarnHRatio1"
                                        placeholder=""
                                        value="<?php echo e($productionEdit[0]->yarnHRatio1 != 'no data' ? $productionEdit[0]->yarnHRatio1 : null); ?>">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHType2" onkeyup="yarntypeFunction('yarnHType2' , 1)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->yarnHType2 != 'no data' ? $productionEdit[0]->yarnHType2 : null); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameH2" onkeyup="supplierFunction('subNameH2' , 1)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->subNameH2 != 'no data' ? $productionEdit[0]->subNameH2 : null); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHCount2" class="form-control" id="yarnHCount2"
                                        placeholder=""
                                        value="<?php echo e($productionEdit[0]->yarnHCount2 != 'no data' ? $productionEdit[0]->yarnHCount2 : null); ?>">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWType1" onkeyup="yarntypeFunction('yarnWType1' , 2)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->yarnWType1 != 'no data' ? $productionEdit[0]->yarnWType1 : null); ?>"
                                        required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameW1" onkeyup="supplierFunction('subNameW1' , 2)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->subNameW1 != 'no data' ? $productionEdit[0]->subNameW1 : null); ?>"
                                        required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWCount1" class="form-control" id="yarnWCount1"
                                        placeholder=""
                                        value="<?php echo e($productionEdit[0]->yarnWCount1 != 'no data' ? $productionEdit[0]->yarnWCount1 : null); ?>"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWType2" onkeyup="yarntypeFunction('yarnWType2' , 3)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->yarnWType2 != 'no data' ? $productionEdit[0]->yarnWType2 : null); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameW2" onkeyup="supplierFunction('subNameW2' , 3)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->subNameW2 != 'no data' ? $productionEdit[0]->subNameW2 : null); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWCount2" class="form-control" id="yarnWCount2"
                                        placeholder=""
                                        value="<?php echo e($productionEdit[0]->yarnWCount2 != 'no data' ? $productionEdit[0]->yarnWCount2 : null); ?>">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWType3" onkeyup="yarntypeFunction('yarnWType3' , 4)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->yarnWType3 != 'no data' ? $productionEdit[0]->yarnWType3 : null); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameW3" onkeyup="supplierFunction('subNameW3' , 4)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->subNameW3 != 'no data' ? $productionEdit[0]->subNameW3 : null); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWCount3" class="form-control" id="yarnWCount3"
                                        placeholder=""
                                        value="<?php echo e($productionEdit[0]->yarnWCount3 != 'no data' ? $productionEdit[0]->yarnWCount3 : null); ?>">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWType4" onkeyup="yarntypeFunction('yarnWType4' , 5)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->yarnWType4 != 'no data' ? $productionEdit[0]->yarnWType4 : null); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameW4" onkeyup="supplierFunction('subNameW4' , 5)"
                                        ...
                                        value="<?php echo e($productionEdit[0]->subNameW4 != 'no data' ? $productionEdit[0]->subNameW4 : null); ?>">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWCount4" class="form-control" id="yarnWCount4"
                                        placeholder=""
                                        value="<?php echo e($productionEdit[0]->yarnWCount4 != 'no data' ? $productionEdit[0]->yarnWCount4 : null); ?>">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="text" name="orderSumYard" oninput="yd(this.value)"
                                                ...
                                                placeholder="หลา"
                                                value="<?php echo e($productionEdit[0]->orderSumYard != null ? $productionEdit[0]->orderSumYard : null); ?>"
                                                required>
                                        </div>
                                        <div class="col-md-1">
                                            หรือ
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" name="orderSumM" oninput="ydToM(this.value)"
                                                ...
                                                placeholder="เมตร"
                                                value="<?php echo e($productionEdit[0]->orderSumM != null ? $productionEdit[0]->orderSumM : null); ?>"
                                                required>
                                        </div>
                                        <div class="col-md-3">
                                            <select name="typrtag" class="form-control" id="typetag">
                                                <?php if($productionEdit[0]->yarnWRatio3 == 'y'): ?>
                                                    <option value="y" selected>หลา</option>
                                                <?php else: ?>
                                                    <option value="y">หลา</option>
                                                <?php endif; ?>
                                                <?php if($productionEdit[0]->yarnWRatio3 == 'm'): ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="text" name="fabricSPY" oninput="pToYd(this.value)"
                                                ...
                                                placeholder="%"
                                                value="<?php echo e($productionEdit[0]->fabricSPY != 'no data' ? $productionEdit[0]->fabricSPY : null); ?>">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="fabricSpP" oninput="ydToP(this.value)"
                                                ...
                                                placeholder="หลา"
                                                value="<?php echo e($productionEdit[0]->fabricSPY != 0 ? ($productionEdit[0]->fabricSPY / 100) * $productionEdit[0]->orderSumYard + $productionEdit[0]->orderSumYard : 0); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no" class="form-control" id="no"
                                        placeholder="" value="<?php echo e($productionEdit[0]->no); ?>">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="typemachine" class="form-control" id="typemachine"
                                        placeholder="" value="<?php echo e($productionEdit[0]->typemachine); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="machinenumber" class="form-control" id="machinenumber"
                                        placeholder="" value="<?php echo e($productionEdit[0]->machinenumber); ?>">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="purchaseOrder" class="form-control" id="purchaseOrder"
                                        placeholder="เลขที่ใบสั่งซื้อ" value="<?php echo e($productionEdit[0]->purchaseOrder); ?>" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="po" class="form-control" id="po"
                                        ...
                                        value="<?php echo e($productionEdit[0]->po != 'no data' ? $productionEdit[0]->po : null); ?>">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <?php if($deadloop < 1): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input class="date form-control" type="text" name="dl[0][dt]"
                                                    id="datepicker1" autocomplete="off"
                                                    value="<?php echo e($flipped_date = date('d/m/Y', strtotime($showDeadline->dt))); ?>">
    ...
    <div class="form-group">
        ...
        <textarea type="" name="comment" class="form-control" id="comment" placeholder="หมายเหตุ"><?php echo e($productionEdit[0]->comment != 'no data' ? $productionEdit[0]->comment : null); ?></textarea>
    </div>
    <div class="form-group">
        <label for="comment2">หมายเหตุการผลิต</label>
        <textarea type="" name="comment2" class="form-control" id="comment2" placeholder="หมายเหตุการผลิต"><?php echo e($productionEdit[0]->comment2 != null ? $productionEdit[0]->comment2 : null); ?></textarea>
    </div>
    <div class="line_btn">
        <button name="submit" value="purchaseorder" class="btn b_order"><img src="<?php echo asset('assets/images/clipboard-list-solid.png'); ?>"
                width="15"><a href="<?php echo e(route('order.index')); ?>">กลับ</a></button>
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/orders/productionEdit.blade.php ENDPATH**/ ?>