...
<?php $__env->startSection('content'); ?>
    ...
    <?php
        // ถ้าตัวแปร vatNox มีค่า เช่น "A-0001"
    ...
    <input type="hidden" id="vatNo1" name="vatNo" value="<?php echo e($realVatNo); ?>">
    <input type="hidden" id="vatType1" name="vatType" value="<?php echo e($realVatType); ?>">
...
print(' <b>หมายเหตุ : </b>'. $comment .'<br>');
    ...
    <script>
        ...
        receiverRadio.addEventListener("click", function() {
            selectOption.value = "A"; // Change select option to A
        });
    
        depositRadio.addEventListener("click", function() {
            selectOption.value = "C"; // Change select option to C
        });
    </script>
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/fabricout/create.blade.php ENDPATH**/ ?>