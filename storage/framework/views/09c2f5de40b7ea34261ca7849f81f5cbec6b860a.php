                             ...
                             print($fabricPattern );
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(isset($backdata)): ?>
                                        <input type="text" onkeyup="fabricIdFunction('fabricId')" name="fabricId"
                                            ...
                                            value="<?php echo e($backdata->fabricId); ?>">
                                    <?php else: ?>
                                        <input type="text" name="fabricId" onkeyup="fabricIdFunction('fabricId')"
                                            ...
                                            placeholder="รหัสผ้า">
                                        <datalist id="brow">
                                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stockFS): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($stockFS->fabricId); ?>,<?php echo e($stockFS->fabricStructure); ?>,<?php echo e($stockFS->fabricPattern); ?>,<?php echo e($stockFS->fabric_w); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <input type="text" name="fabricStruct" 
                                            class="form-control" id="fabricStructureInput" placeholder="โครงสร้างผ้า"
                                            value="<?php echo e($fabricStruct); ?>" required>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(isset($backdata)): ?>
                                        <input type="text" name="fabricPattern" class="form-control"
                                            ...
                                            value="<?php echo e($backdata->fabricPattern); ?>">
                                    <?php else: ?>
                                        <input type="text" name="fabricPattern" class="form-control"
                                            id="fabricPatternInput" placeholder="ลายผ้า" value="<?php echo e($fabricPattern); ?>"
                                            required>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <input type="text" name="fabricW" class="form-control" id="fabricWidthInput"
                                            placeholder="หน้ากว้าง" value="<?php echo e($fabricW); ?> " required>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(isset($backdata)): ?>
                                        <input type="text" name="customer" list="brow2" id="customer"
                                            ...
                                            value="<?php echo e($backdata->fabricW); ?>">
                                        <datalist id="brow2">
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/inventory/create.blade.php ENDPATH**/ ?>