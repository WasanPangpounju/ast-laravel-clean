    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="box-from">
                ...
                <form method="post" action="<?php echo e(route('materialoutside.store')); ?>" id="myForm">
                    <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <ul class="yarntypeUL">
                        <?php $__currentLoopData = $stockYarns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $yarntype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="javascript:setyarntypeFunction('', '<?php echo e($key); ?>');"><?php echo e($key); ?></a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                ...
                <div class="form-group">
                    ...
                    <?php if(isset($backdata)): ?>
                        <input type="number" name="partition" class="form-control" id=""
                            placeholder="จำนวนกระดาษกั้น" value="<?php echo e($backdata->partition); ?>" >
                    <?php else: ?>
                        <input type="number" name="partition" class="form-control" id=""
        ...
        <div class="row">
            ...
            <div class="col-md-9" style="margin-top:10px;">
                ...
                <div class="icheck-primary d-inline">
                    <?php if(isset($backdata) && $backdata->packaging5 == 'pallet'): ?>
                    ...
                    <div class="col-form">
                        <?php if(isset($backdata)): ?>
                            <input type="text" name="recipient" class="form-control" id="inputEmail3"
                                placeholder="ผู้รับวัตถุดิบ" value="<?php echo e($backdata->recipient); ?>" required>
                        <?php else: ?>
                            <input type="text" name="recipient" class="form-control" id="inputEmail3"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-form">
                        <?php if(isset($backdata)): ?>
                            <textarea name="comment" class="form-control" id="inputEmail3" placeholder="การนำไปใช้"><?php echo e($backdata->comment); ?></textarea>
                        <?php else: ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-form">
                        <?php if(isset($backdata)): ?>
                            <textarea name="paymentComment" class="form-control" id="inputEmail3" placeholder="paymentComment"><?php echo e($backdata->paymentComment); ?></textarea>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.astmanufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ast-menufacturing/resources/views/materialoutside/create.blade.php ENDPATH**/ ?>