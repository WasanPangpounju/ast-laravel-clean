                ...
                <div class="box-from">
                    ...
                    <form onsubmit="createFabricStructure()" method="post" action="{{ route('order.store') }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarn_h_count" class="form-control" id="yarn_h_count"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fabric_w" class="form-control" id="fabric_w"
                        ...
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="orderSumYard"
                                                ...
                                                class="form-control" id="orderSumYard" placeholder="หลา" required>
                                        </div>
                                        <div class="col-md-1">
                                            หรือ
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" name="orderSumM"
                                                ...
                                                class="form-control" id="orderSumM" placeholder="เมตร" required>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="fabricSPY">การสืบ * (ไม่มีใส่เลข 0)</label>
                                    <div class="row">
                                        {{-- <div class="col-md-5">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="fabricSPY"
                                                ...
                                                class="form-control" id="fabricSPY" placeholder="%" required>
                                        </div>
                                        <div class="col-md-1">หรือ</div>
                                        <div class="col-md-6">
                                            <input type="text" name="fabricSpy"
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="text" name="priceYard"
                                                ...
                                                class="form-control" id="priceYard" placeholder="หลา" required>
                                        </div>
                                        <div class="col-md-1">
                                            หรือ
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" name="priceM"
                                                ...
                                                class="form-control" id="priceM" placeholder="เมตร" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            function formatAndCalculate(inputElement, targetId, calculationFunction) {
                ...
                if (isNaN(originalValue)) {
                    inputElement.value = ''; // Clear the input field if the value is not a number
                    document.getElementById(targetId).value = ''; // Clear the target field as well
                    return;
                }
                ...
                inputElement.value = originalValue.toLocaleString('en-US', {
                    style: 'decimal',
                    maximumFractionDigits: 2
                });

                // Display the result in the target input field
                document.getElementById(targetId).value = result.toLocaleString('en-US', {
                    style: 'decimal',
                    maximumFractionDigits: 2
                });
            }
            ...
            function ydToM(valNum) {
                if (isNaN(valNum)) {
                    return ''; // return an empty string for non-numeric or invalid inputs
                }
                return (valNum / 0.9144).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            }
            ...
            function pToYd(valNum) {
                ...
                // return sppYd;
                if (isNaN(ordernum) || isNaN(valNum)) {
            ...
            function discountToPriceYd(valNum) {
                var pyd = parseFloat(document.getElementById('discountP').value.replace(/,/g, ''));
                // var discountYd = ((pyd * valNum) / 100).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
                // return discountYd;

                // var orderyd = parseFloat(document.getElementById('orderSumYard').value.replace(/,/g, ''));
                if (isNaN(pyd) || isNaN(valNum)) {
                    return ''; // Return an empty string if the input is not a number
                }
                var discountYd = ((pyd * valNum) / 100).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
                return discountYd;
