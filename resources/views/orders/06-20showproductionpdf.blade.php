    ...
    <div class="content">
            ...
            <div class="detail" style="font-size: 1.05rem">
                <div class="row">
                    <div class="col-md-12"style="margin-top: 0rem;">
                        ...
                        <strong>เลขที่ใบโครงสร้าง : {{ $showproduction->purchaseOrder }} </strong>
        ...
        <div class="row" style="margin-top: 1rem;">
            ...
            <div class="col-6 table-responsive">
                <p><strong>ผู้สั่งงาน________________________________________________________________________________</strong></p>
            </div>
            <div class="col-6 table-responsive">
                <p><strong>ผู้ตรวจสอบ______________________________________________________________________________</strong></p>
            </div>
        </div>
    </div>
    <!--content-->
