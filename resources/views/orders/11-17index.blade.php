            ...
            <div class="box-from">
                <div class="">
                    ...
                    @if (isset($importorder) && count($importorder) > 0)
                        @if (isset($select_search) == 'customerName')
                            ...
                            <!--List_table-->
                        @elseif(isset($select_search) == 'imDate')
                            <div class="List_table">
                                <div class="row">
                                    <div class="col-12 table-responsive">
                                        <table class="table table-bordered">
                                                ...
                                                @foreach ($importorder as $order)
                                                    <tr>
                                                        ...
                                                        <td>{{ $order->customerName }} รหัสผ้า {{ $order->fabricId }}
                                                            ...
                                                            <br>
                                                            {{ // $order->fabricStructure
                                                                str_replace('undefined', '', $order->fabricStructure) }}<a
                                                                href="{{ route('order.show', $order->id) }}">รายละเอียด</a>
                                                        </td>
                                                        <td>
                                                            @if ($order->status == 'no data')
                                                                สร้างใบสั่งซื้อ
                                                                <form method="POST"
                                                                    action="{{ route('order.store', $order->id) }}">
                                                                    @csrf
                            ...
                            <!--List_table-->
                        @elseif(isset($select_search) == 'yarnHType1')
                            <div class="List_table">
                                <div class="row">
                                    <div class="col-12 table-responsive">
                                        <table class="table table-bordered">
                            ...
                            <!--List_table-->
                        @elseif(isset($select_search) == 'yarnWType1')
                            <div class="List_table">
                                <div class="row">
                                    <div class="col-12 table-responsive">
                                        <table class="table table-bordered">
                            ...
                            <!--List_table-->
                        @elseif(isset($select_search) == 'yarn_h_count')
                            <div class="List_table">
                                <div class="row">
                                    <div class="col-12 table-responsive">
                                        <table class="table table-bordered">
                            ...
                            <!--List_table-->
                        @elseif(isset($select_search) == 'yarnWCount1')
                            <div class="List_table">
                                <div class="row">
                                    <div class="col-12 table-responsive">
                                        <table class="table table-bordered">
