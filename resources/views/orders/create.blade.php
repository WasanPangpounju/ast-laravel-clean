...
@section('content')
    ...
    @else
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-md-5">
                                            <input type="text" name="discountP"
                                                oninput="formatAndCalculate('discountP')" class="form-control"
                                                id="discountP" placeholder="%">
                                        </div>
                                        <div class="col-md-1">หรือ</div>
                                        <div class="col-md-6">
                                            <input type="text" name="discountYard"
                                                oninput="formatAndCalculate('discountYard')" class="form-control"
                                                id="discountYard" placeholder="หลา">
                                        </div> --}}
                                        {{-- <div class="col-md-5">
                                            <input type="text" name="discountP"
        ...
        {{-- <script>
            function formatAndCalculate(inputId) {
            ...
            function calculate() {
                var a = parseFloat(document.getElementById('a').value.replace(/,/g, ''));
                var b = parseFloat(document.getElementById('b').value.replace(/,/g, ''));
                var result = a * b;
                var formattedResult = formatNumber(result.toFixed(2));
                document.getElementById('c').value = formattedResult;
            }
