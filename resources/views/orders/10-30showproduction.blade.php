                ...
                <div class="detail" style="font-size: 1.05rem">
                    <div class="row">
                        ...
                        <div class="col-5 table-responsive">
                            <?php
                            $text = 'Hello, World!';
                            $cut_text = str_replace('World', '', $text); // Removes "World"
                            ?>
                            {{-- <b>โครงสร้างผ้า : </b> <ins>{{ $showproduction->s1 }}</ins><br> --}}
                            <b>โครงสร้างผ้า : </b> <ins><?php echo str_replace('undefined', '', $showproduction->s1); ?></ins><br>

                            {{-- <b style="margin-right: 6rem"></b>{{ $showproduction->s2 }}<br><br> --}}
                            <b style="margin-right: 6rem"></b><?php echo str_replace('undefined', '', $showproduction->s1); ?><br><br>
                        </div>
