...
@section('content')
            ...
            <div class="content">
                <div class="box-from">
                    ...
                    <form onsubmit="createFabricStructure()" method="post"
                        action="{{ route('order.store', $orderEdit->id) }}">
                        @csrf

                        <input type="hidden" id="refId" name="refId" value="{{ $orderEdit->id }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="date form-control" type="text" name="createDate" autocomplete="off"
                                            value="{{ $flipped_date = date('d/m/Y', strtotime($orderEdit->createDate)) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="typemachine" class="form-control" id="typemachine"
                                        placeholder="" value="{{ $orderEdit->typemachine }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="machinenumber" class="form-control" id="machinenumber"
                                        placeholder="" value="{{ $orderEdit->machinenumber }}">
                                </div>
                            </div>
                        </div>
                        <!--row-->
    ...
    <div class="line_btn">
        ...
        <button name="submit" value="generateproduction" class="btn b_save"><img src="<?php echo asset('assets/images/circle-check-solid.png'); ?>"
                width="17">
            สร้างใบโครงสร้าง</button>
    </div>
    </form>
    </div>
    <!--box-from-->
