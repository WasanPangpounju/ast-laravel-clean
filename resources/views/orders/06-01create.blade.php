                    ...
                    <form onsubmit="createFabricStructure()" method="post" action="{{ route('order.store') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="purchaseOrder" class="form-control" id="purchaseOrder" 
                                        placeholder="เลขที่ใบสั่งซื้อ" value="{{ $so }}" readonly/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="line_btn">
                            <button name="submit" value="purchaseorder" class="btn b_order"><img
                                    src="<?php echo asset('assets/images/clipboard-list-solid.png'); ?>" width="15"> ใบสั่งซื้อ</button>
                            <button name="submit" value="production" class="btn b_save"><img src="<?php echo asset('assets/images/circle-check-solid.png'); ?>" width="17"> สั่งผลิต</button>
                        </div>
                    </form>
                </div>
                <!--box-from-->
