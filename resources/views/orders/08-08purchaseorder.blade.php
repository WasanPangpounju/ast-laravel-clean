                        ...
                        <table class="table table-a" style="text-align: center">
                            <thead>
                                <tr>
                                    <th>ลำดับ </th>
                                    <th>รายการสินค้า</th>
                                    @if ($showpurchaseorder->typrtag == 'm')
                                        <th>จำนวนเมตร</th>
                                    @else
                                        <th>จำนวนหลา</th>
                                    @endif
                                ...
                                <tr>
                                    ...
                                    @if ($showpurchaseorder->typrtag == 'm')
                                        <td>
                                            ...
                                            <p id="orderSumYard"></p>
                                            <script>
                                                const orderSumYard = {{ $showpurchaseorder->orderSumM }};
                                    ...
                                    @if ($showpurchaseorder->typrtag == 'm')
                                        <td>
                                            ...
                                            <p id="priceYard"></p>
                                            <script>
                                                const priceYard = {{ $showpurchaseorder->priceM }};
            ...
            <div class="purchase_order_signature">
                <div class="row">
                    ...
                    <form action="{{ route('order.store') }}" method="post" target="_blank">
                        @csrf
                        <input type="hidden" name="customerName" value="{{ $showpurchaseorder->customerName }}">
                        ...
                        <input type="hidden" name="purchaseOrder" value="{{ $showpurchaseorder->purchaseOrder }}">
                        ...
                        <input type="hidden" name="fabricPattern" value="{{ $showpurchaseorder->fabricPattern }}">
                        ...
                        <input type="hidden" name="orderSumYard" value="{{ $showpurchaseorder->orderSumYard }}">
                        ...
                        <input type="hidden" name="typrtag" value="{{ $showpurchaseorder->typrtag }}">
                        ...
                        {{-- <form method="post" action="{{ route('order.store') }}">
                                @csrf --}}
                        <input type="hidden" id="" name="id" value="{{ $showpurchaseorder->id }}">
