...
@section('content')
            ...
            <div class="content">
                <div class="box-from">
                    ...
                    <div class="date_order"><strong>สร้างเมื่อ
                        </strong>{{ date('l, j F Y H:i A', strtotime($orderEdit->created_at)) }}<span><strong></strong></span>
                    </div>

                    <form onsubmit="createFabricStructure()" method="post"
                        action="{{ route('order.update', $orderEdit->id) }}">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    {{-- <div style="z-index: 9999;" class="input-group date" id="reservationdate"
                                        ...
                                        <input type="text" name="createDate" class="form-control datetimepicker-input"
                                            data-target="#reservationdate" value="{{ $orderEdit->createDate }}" />
                                    ...
                                    <div class="input-group">
                                        {{-- <input type="date" name="createDate" id="startDate"
                                            value="{{ $flipped_date = date('Y-m-d', strtotime(str_replace('/', '-', $orderEdit->createDate))) }}"
                                            class="form-control" date-format="d/m/Y"> --}}

                                        {{-- yyyy-mm-dd to dd/mm/yyyy --}}
                                        {{-- {{ $formatted_date = date('d/m/Y', strtotime($orderEdit->createDate)) }}  --}}
                                        {{-- {{-- dd/mm/yyyy to yyyy-mm-dd --}}
                                        {{-- {{ $flipped_date = date('Y-m-d', strtotime(str_replace('/', '-', $formatted_date))) }} --}}

                                        <input class="date form-control" type="text" name="createDate"
                                            value="{{ $date = date('d/m/Y', strtotime($orderEdit->createDate)) }}"
                                            autocomplete="off">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customerName" class="form-control" id="myInput"
                                        ...
                                        value="{{ $orderEdit->customerName }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="coname" class="form-control" id="coname"
                                        placeholder="ชื่อผู้ประสานงาน" value="{{ $orderEdit->deadline }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fabricId" class="form-control" id="fabricId"
                                        placeholder="รหัสผ้า" value="{{ $orderEdit->fabricId }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fabricPattern" class="form-control" id="fabricPattern"
                                        placeholder="ลายผ้า" value="{{ $orderEdit->fabricPattern }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fabricStructure" class="form-control"
                                        ...
                                        value="{{ $orderEdit->fabricStructure }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="yarn_h_count" class="form-control" id="yarn_h_count"
                                        ...
                                        value="{{ $fabricpaymentEdit[0]->yarn_h_count }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-md-5">
                                            <input type="text" name="orderSumYard" oninput="yd(this.value)"
                                                ...
                                                placeholder="หลา"
                                                value="{{ $orderEdit->orderSumYard != null ? $orderEdit->orderSumYard : null }}"
                                                required>
                                        </div>
                                        <div class="col-md-1">
                                            หรือ
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" name="orderSumM" oninput="ydToM(this.value)"
                                                ...
                                                placeholder="เมตร"
                                                value="{{ $orderEdit->orderSumM != null ? $orderEdit->orderSumM : null }}"
                                                required>
                                        </div> --}}

                                        <div class="col-md-5">
                                            <input type="text" name="orderSumYard"
                                                oninput="formatAndCalculate(this, 'orderSumM', ydToM)"
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" name="orderSumM"
                                                oninput="formatAndCalculate(this, 'orderSumYard', yd)"
                                    ...
                                    <div class="row">
                                        {{-- <div class="col-md-5">
                                            <input type="text" name="fabricSPY" oninput="pToYd(this.value)"
                                                ...
                                                placeholder="%"
                                                value="{{ $orderEdit->fabricSPY != 'no data' ? $orderEdit->fabricSPY : null }}">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="fabricSpy" oninput="ydToP(this.value)"
                                                ...
                                                placeholder="หลา"
                                                value="{{ $orderEdit->fabricSPY != 0 ? ($orderEdit->fabricSPY / 100) * $orderEdit->orderSumYard + $orderEdit->orderSumYard : 0 }}">
                                        </div> --}}
                                        <div class="col-md-5">
                                            <input type="text" name="fabricSPY"
                                                oninput="formatAndCalculate(this, 'fabricSpy', pToYd)"
                                                class="form-control" id="fabricSPY" placeholder="%"
                                                value="{{ $orderEdit->fabricSPY != 'no data' ? $orderEdit->fabricSPY : null }}"
                                                required>
                                        </div>
                                        <div class="col-md-1">หรือ</div>
                                        <div class="col-md-6">
                                            <input type="text" name="fabricSpy"
                                                oninput="formatAndCalculate(this, 'fabricSPY', ydToP)"
                                                class="form-control" id="fabricSpy" placeholder="หลา">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        {{-- <div class="col-md-5">
                                            <input type="text" name="priceYard" oninput="priceToM(this.value)"
                                                ...
                                                placeholder="หลา" value="{{ $orderEdit->priceYard }}" required>
                                        </div>
                                        <div class="col-md-1">
                                            หรือ
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" name="priceM" oninput="priceToY(this.value)"
                                                ...
                                                placeholder="เมตร" value="{{ $orderEdit->priceM }}" required>
                                        </div> --}}
                                        <div class="col-md-5">
                                            <input type="text" name="priceYard"
                                                oninput="formatAndCalculate(this, 'priceM', priceToM)"
                                                class="form-control" id="priceYard" placeholder="หลา"
                                                value="{{ $orderEdit->priceYard }}" required>
                                        </div>
                                        <div class="col-md-1">
                                            หรือ
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" name="priceM"
                                                oninput="formatAndCalculate(this, 'priceYard', priceToY)"
                                                class="form-control" id="priceM" placeholder="เมตร"
                                                value="{{ $orderEdit->priceM }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        {{-- <div class="col-md-5">
                                            <input type="text" name="discountP"
                                                ...
                                                id="discountP" placeholder="%" value="{{ $orderEdit->discountP }}">
                                        </div>
                                        <div class="col-md-1">หรือ</div>
                                        <div class="col-md-6">
                                            <input type="text" name="discountYard"
                                                ...
                                                value="{{ $orderEdit->discountYard }}">
                                        </div> --}}
                                        <div class="col-md-5">
                                            <input type="text" name="discountP"
                                                oninput="formatAndCalculate(this, 'discountYard', discountToPriceYd)"
                                                class="form-control" id="discountP" placeholder="%"
                                                value="{{ $orderEdit->discountP }}">
                                        </div>
                                        <div class="col-md-1">หรือ</div>
                                        <div class="col-md-6">
                                            <input type="text" name="discountYard"
                                                oninput="formatAndCalculate(this, 'discountP', discountToPriceP)"
                                                class="form-control" id="discountYard" placeholder="หลา"
                                                value="{{ $orderEdit->discountYard }}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="surcharge" class="form-control" id="surcharge"
                                        ...
                                        value="{{ $fabricStructureEdit[0]->yarnWRatio4 != 'no data' ? $fabricStructureEdit[0]->yarnWRatio4 : null }}">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="commission" class="form-control" id="commission"
                                        ...
                                        value="{{ $orderEdit->commission != 'no data' ? $orderEdit->commission : null }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="vat" class="form-control" id="selectVal">
                                        ...
                                        <option value="{{ $orderEdit->vat }}" selected>แก้ไขไม่ได้</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="purchaseOrder" class="form-control" id="purchaseOrder"
                                        placeholder="เลขที่ใบสั่งซื้อ" value="{{ $orderEdit->purchaseOrder }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="po" class="form-control" id="po"
                                        ...
                                        value="{{ $orderEdit->po != 'no data' ? $orderEdit->po : null }}">
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class="datepicker1 form-control" type="text"
                                                        name="dl[0][dt]"
                                                        {{-- value="{{ $date = date('Y/m/d', strtotime($showDeadline->dt)) }}" --}}
                                                        autocomplete="off">
                                                    {{-- $date = date('d/m/Y', strtotime($orderEdit->createDate)) --}}
    ...
    <div class="form-group">
        ...
        <textarea type="" name="comment" class="form-control" id="comment" placeholder="หมายเหตุ">{{ $orderEdit->comment != 'no data' ? $orderEdit->comment : null }}</textarea>
    </div>
    <div class="form-group">
        <label for="comment2">หมายเหตุการผลิต</label>
        <textarea type="" name="comment2" class="form-control" id="comment2" placeholder="หมายเหตุการผลิต">{{ $orderEdit->comment2 != null ? $orderEdit->comment2 : null }}</textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea type="" name="payment" class="form-control" id="payment"
            placeholder="ชำระเงินภายใน 15 วันหลังได้รับสินค้า" value="ชำระเงินภายใน 15 วันหลังได้รับสินค้า">{{ $fabricpaymentEdit[0]->payment != 'no data' ? $fabricpaymentEdit[0]->payment : null }}</textarea>
    </div>

    <div class="line_btn">
        <button name="submit" value="purchaseorder" class="btn b_order"><img src="<?php echo asset('assets/images/clipboard-list-solid.png'); ?>"
                width="15"><a href="{{ route('order.index') }}">กลับหน้ารายการ</a></button>
    ...
    <script>
        // fix calculate///////////////
        function formatAndCalculate(inputElement, targetId, calculationFunction) {
            // Remove commas from the input value
            const originalValue = parseFloat(inputElement.value.replace(/,/g, ''));

            // Format the value with commas and update the input field
            const formattedValue = originalValue.toLocaleString('en-US', {
                style: 'decimal',
                maximumFractionDigits: 2
            });
            inputElement.value = formattedValue;

            // Continue calculations and update the target input field
            const result = calculationFunction(originalValue);
            document.getElementById(targetId).value = result;
        }

        function ydToM(valNum) {
            return (valNum / 0.9144).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
        }
        ...
        function pToYd(valNum) {
            var ordernum = parseFloat(document.getElementById('orderSumM').value.replace(/,/g, ''));
            var sppYd = ((ordernum * (valNum / 100)) + ordernum).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            return sppYd;
        }

        function ydToP(valNum) {
            var ordernum = parseFloat(document.getElementById('orderSumYard').value.replace(/,/g, ''));
            var sppP = (ordernum / valNum).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            return sppP;
        }
        ...
        function priceToM(valNum) {
            ...
            var sumPriceP = orderp * valNum;
            var pyd = (sumPriceP / (orderp * 0.9144)).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            return pyd;
        }
        ...
        function priceToY(valNum) {
            ...
            var sumPriceYd = orderyd * valNum;
            var pm = (sumPriceYd / (orderyd / 0.9144)).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            return pm;
        }

        function discountToPriceYd(valNum) {
            var pyd = parseFloat(document.getElementById('priceYard').value.replace(/,/g, ''));
            var discountYd = ((pyd * valNum) / 100).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            return discountYd;
        }

        function discountToPriceP(valNum) {
            var pyd = parseFloat(document.getElementById('priceYard').value.replace(/,/g, ''));
            var discountP = ((valNum * 100) / pyd).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            return discountP;
        }
    </script>
