            ...
            <div class="detail" style="font-size: 1.5rem">
                <div class="row">
                    <div class="col-md-12"style="margin-top: 0rem;">
                        ...
                        {{-- <strong>ชื่อลูกค้า : <?php echo str_replace('(สำนักงานใหญ่)', '', $showproduction->customerName); ?> </strong>
                        <strong> วันที่ : <?php echo date('d/m/Y', strtotime($showproduction->createDate)); ?> </strong>
                         <strong style="text-align: right">  No. : {{ $showproduction->no }} </strong> --}}
                        <strong style="text-align: left">ชื่อลูกค้า:
                            {{ str_replace('(สำนักงานใหญ่)', '', $showproduction->customerName) }}</strong>
                        <strong style="text-align: center; margin-left: 1rem">วันที่:
                            {{ date('d/m/Y', strtotime($showproduction->createDate)) }}</strong>
                        <strong style="text-align: right; margin-left: 7rem">No.: {{ $showproduction->no }}</strong>
            ...
            <div class="detail" style="font-size: 1.5rem;margin-top: -1.5rem;">
                <div class="row" style="margin-top: 0.5rem;">
                    ...
                    <div class="col-5 table-responsive">
                        {{-- <b>โครงสร้างผ้า : </b> {{ $showproduction->s1 }}<br>
                        <b style="margin-left: 8rem;margin-right: 2rem">:</b>{{ $showproduction->s2 }}<br><br> --}}
                    ...
                    <div class="col-2 table-responsive">
                        <b> : </b> {{ $showproduction->fabric_w }} นิ้ว<br><br>
                        <br>
                    </div>
                ...
                <div class="row" style="margin-top: -3rem;;">
                    ...
                    <div class="col-1 table-responsive">
                    </div>
                    <div class="col-5 table-responsive">
