                            ...
                            <div class="col-md-4">
                                @if ($showpurchaseorder->vat == 'SO')
                                    <strong>
                                        ...
                                        <strong id="discountP4" style='float:right; margin-right:0.5em;'></strong>11
                                        <script>
                                    ...
                                    @elseif($showpurchaseorder->vat == 'SOX')
                                        ...
                                        <strong id="discountP5" style='float:right; margin-right:0.5em;'></strong>22
                                        <script>
                                    ...
                                    @else
                                        {{-- <strong> {{ $price - $price * ($showpurchaseorder->discountP / 100) }}
                                        บาท</strong> --}}
                                        <strong id="discountP6" style='float:right; margin-right:0.5em;'></strong>33
                                        <script>
