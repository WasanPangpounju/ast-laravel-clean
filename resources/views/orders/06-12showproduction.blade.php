...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content">
        <div class="inner_content">
                ...
                <div class="detail" style="font-size: 1.05rem">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 table-responsive"><b>บริษัท : </b>
                            <?php $subNameH1 = str_replace(['บริษัท', 'จำกัด'], '', $showproduction->subNameH1); ?>
                            {{ $subNameH1 }}<br><br></div>
                    </div>
                    <div class="row">
                        <div class="col-2 table-responsive"></div>
                        ...
                        <div class="col-4 table-responsive"><b>บริษัท : </b>
                            <?php $subNameW1 = str_replace(['บริษัท', 'จำกัด'], '', $showproduction->subNameW1); ?>
                            {{ $subNameW1 }}<br><br></div>
                    </div>
                    <div class="row">
                        <div class="col-2 table-responsive"></div>
            ...
            <div class="purchase_order_signature">
                <div class="row">
                    <div class="col-md-2" style="margin-left:5.5em;">
