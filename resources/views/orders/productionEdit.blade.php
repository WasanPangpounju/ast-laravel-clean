                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="yarn_h_count" class="form-control" id="yarn_h_count"
                                        ...
                                        value="{{ $productionEdit[0]->yarn_h_count }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fabric_w" class="form-control" id="fabric_w"
                                        placeholder="หน้าผ้า (นิ้ว)" value="{{ $productionEdit[0]->fabric_w }}"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHType1" onkeyup="yarntypeFunction('yarnHType1' , 0)"
                                        ...
                                        value="{{ $productionEdit[0]->yarnHType1 }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameH1" onkeyup="supplierFunction('subNameH1' , 0)"
                                        ...
                                        value="{{ $productionEdit[0]->subNameH1 }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHCount1" class="form-control" id="yarnHCount1"
                                        placeholder="" value="{{ $productionEdit[0]->yarnHCount1 }}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHRatio1" class="form-control" id="yarnHRatio1"
                                        placeholder=""
                                        value="{{ $productionEdit[0]->yarnHRatio1 != 'no data' ? $productionEdit[0]->yarnHRatio1 : null }}">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHType2" onkeyup="yarntypeFunction('yarnHType2' , 1)"
                                        ...
                                        value="{{ $productionEdit[0]->yarnHType2 != 'no data' ? $productionEdit[0]->yarnHType2 : null }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameH2" onkeyup="supplierFunction('subNameH2' , 1)"
                                        ...
                                        value="{{ $productionEdit[0]->subNameH2 != 'no data' ? $productionEdit[0]->subNameH2 : null }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnHCount2" class="form-control" id="yarnHCount2"
                                        placeholder=""
                                        value="{{ $productionEdit[0]->yarnHCount2 != 'no data' ? $productionEdit[0]->yarnHCount2 : null }}">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWType1" onkeyup="yarntypeFunction('yarnWType1' , 2)"
                                        ...
                                        value="{{ $productionEdit[0]->yarnWType1 != 'no data' ? $productionEdit[0]->yarnWType1 : null }}"
                                        required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameW1" onkeyup="supplierFunction('subNameW1' , 2)"
                                        ...
                                        value="{{ $productionEdit[0]->subNameW1 != 'no data' ? $productionEdit[0]->subNameW1 : null }}"
                                        required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWCount1" class="form-control" id="yarnWCount1"
                                        placeholder=""
                                        value="{{ $productionEdit[0]->yarnWCount1 != 'no data' ? $productionEdit[0]->yarnWCount1 : null }}"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWType2" onkeyup="yarntypeFunction('yarnWType2' , 3)"
                                        ...
                                        value="{{ $productionEdit[0]->yarnWType2 != 'no data' ? $productionEdit[0]->yarnWType2 : null }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameW2" onkeyup="supplierFunction('subNameW2' , 3)"
                                        ...
                                        value="{{ $productionEdit[0]->subNameW2 != 'no data' ? $productionEdit[0]->subNameW2 : null }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWCount2" class="form-control" id="yarnWCount2"
                                        placeholder=""
                                        value="{{ $productionEdit[0]->yarnWCount2 != 'no data' ? $productionEdit[0]->yarnWCount2 : null }}">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWType3" onkeyup="yarntypeFunction('yarnWType3' , 4)"
                                        ...
                                        value="{{ $productionEdit[0]->yarnWType3 != 'no data' ? $productionEdit[0]->yarnWType3 : null }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameW3" onkeyup="supplierFunction('subNameW3' , 4)"
                                        ...
                                        value="{{ $productionEdit[0]->subNameW3 != 'no data' ? $productionEdit[0]->subNameW3 : null }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWCount3" class="form-control" id="yarnWCount3"
                                        placeholder=""
                                        value="{{ $productionEdit[0]->yarnWCount3 != 'no data' ? $productionEdit[0]->yarnWCount3 : null }}">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWType4" onkeyup="yarntypeFunction('yarnWType4' , 5)"
                                        ...
                                        value="{{ $productionEdit[0]->yarnWType4 != 'no data' ? $productionEdit[0]->yarnWType4 : null }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subNameW4" onkeyup="supplierFunction('subNameW4' , 5)"
                                        ...
                                        value="{{ $productionEdit[0]->subNameW4 != 'no data' ? $productionEdit[0]->subNameW4 : null }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="yarnWCount4" class="form-control" id="yarnWCount4"
                                        placeholder=""
                                        value="{{ $productionEdit[0]->yarnWCount4 != 'no data' ? $productionEdit[0]->yarnWCount4 : null }}">
                                </div>
                            </div>
                        </div>
                        <!--row-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select name="typrtag" class="form-control" id="typetag">
                                                @if ($productionEdit[0]->yarnWRatio3 == 'y')
                                                    <option value="y" selected>หลา</option>
                                                @else
                                                    <option value="y">หลา</option>
                                                @endif
                                                @if ($productionEdit[0]->yarnWRatio3 == 'm')
