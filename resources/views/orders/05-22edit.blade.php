        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="box-from">
                    ...
                    <form onsubmit="createFabricStructure()" method="post" action="{{ route('order.update', $orderEdit->id) }}">
                        @csrf
                        @method('PUT')
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                {{-- <input type="text" class="form-control datepicker" id="datepicker1"
                                                    name="dl[0][dt]"> --}}
                                                <input type="date" name="dl[0][dt]" id="datepicker1"
                                                    class="form-control" placeholder="dd-mm-yyyy"  value="{{ $flipped_date = date('Y-m-d', strtotime( $showDeadline->dt))}}" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn btn-danger remove-input-field">ลบ</button>
                                            </td>
                                        </tr>
...
@endif
                        ...
                        <div class="line_btn">
                            <button name="submit" value="purchaseorder" class="btn b_order"><img
                                    src="<?php echo asset('assets/images/clipboard-list-solid.png'); ?>" width="15"><a
                                    href="{{ route('order.index') }}">กลับหน้ารายการ</a></button>
                            <button name="submit" value="update" class="btn b_save"><img src="<?php echo asset('assets/images/circle-check-solid.png'); ?>"
                                    width="17"> บันทึก</button>
                        </div>
                    </form>
                </div>
                <!--box-from-->
