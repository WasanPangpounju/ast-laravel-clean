    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="box-from">
                ...
                <form method="post" action="{{ route('inventory.update', $inventoryedit->id) }}" id="myForm">
                    @csrf
                    @method('PATCH')
                    <input type="hidden" id="refId" name="refId" value="{{ $inventoryedit->refId }}">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="inventoryName">บันทึกที่คลังสินค้า * </label>
                                <select name="inventoryName" class="form-control" id="inventoryName">
                                    <!-- <option value="" disabled selected hidden>In VAT</option> -->
                                    <option value="สินค้ารอผลิต">สินค้ารอผลิต</option>
                                    <option value="สินค้ารอขาย">สินค้ารอขาย</option>
                                    <option value="สินค้าฝากจัดเหก็บ">สินค้าฝากจัดเก็บ</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                @else
                                    <input type="text" name="orderId" onkeyup="supplierFunction('orderId')"
                                        class="form-control" id="orderId" value="{{ $inventoryedit->orderId }}"
                                ...
                                @if (isset($backdata))
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <input type="text" name="createDate" class="form-control datetimepicker-input"
                                            ...
                                            data-target="#reservationdate" value="{{ $inventoryedit->createDate }} " />
                        ...
                        @else
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" name="createDate" class="form-control datetimepicker-input" value="{{ $inventoryedit->createDate }}
        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="fabricId" class="form-control" id="fabricId"
                            value="{{ $inventoryedit->fabricId }}" placeholder="รหัสผ้า">
                    @endif
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="fabricStruct" class="form-control" id="fabricStruct"
                            value="{{ $inventoryedit->fabricStruct }}" placeholder="โครงสร้างผ้า">
                    @endif
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="fold" class="form-control" id="fold" placeholder="จำนวนพับ"
                            value="{{ $inventoryedit->fold }}" required>
                    @endif
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="sumYard" class="form-control" id="sumYard" placeholder="จำนวนหลา"
                            value="{{ $inventoryedit->sumYard }}" oninput="yd(this.value)" onchange="yd(this.value )"
                            required>
                    @endif
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="sumM" class="form-control" id="sumM"
                            oninput="ydToM(this.value)" onchange="ydToM(this.value )" placeholder="จำนวนเมตร"
                            value="{{ $inventoryedit->sumM }}" required>
                    @endif
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="fabricW" class="form-control" id="fabricW"
                            value="{{ $inventoryedit->fabricW }}" placeholder="หน้ากว้าง" required>
                    @endif
        ...
        <div class="form-group">
            ...
            <textarea type="" name="comment" class="form-control" id="comment" placeholder="หมายเหตุ">{{ $inventoryedit->comment }}</textarea>
        </div>
        <div class="line_btn">
            ...
            {{-- <button name="submit" value="checkdata" class="btn b_save"><img src="<?php echo asset('assets/images/circle-check-solid.png'); ?>" width="17">
                ตรวจสอบ</button> --}}
            <button type="submit" name="submit" value="updatedata" class="btn b_save"><img src="<?php echo asset('assets/images/circle-check-solid.png'); ?>" width="17">
                แก้ไข</button>
        </div>
