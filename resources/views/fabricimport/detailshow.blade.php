        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="box-from">
                    ...
                    <!--row-->
                    {{-- <?php print_r($inventorydata); ?>
                    <?php print_r('1351351'); ?> --}}
                    @foreach ($inventorydata as $withorders1)
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-3">
                                <p><b>บันทึกที่คลังสินค้า :</b> {{ $withorders1->inventoryName }}
                            </div>
                            <div class="col-md-3">
                                <p><b>วันที่ :</b> {{ date('d/m/Y', strtotime($withorders1->createDate)) }} </p>
                            </div>
                            <div class="col-md-1">
                                <form method="POST" action="{{ route('inventory.destroy', $withorders1->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <div style="  display: flex;justify-content: center;align-items: center;">
                                        
                                        <button class="btn b_order" type="button"><a
                                                href="{{ route('inventory.edit', $withorders1->id) }}">แก้ไข</a></button>
                        ...
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-3">
                                <p><b>จำนวนพับ :</b> {{ $withorders1->fold }} <b>พับ</b>
                            </div>
                            <div class="col-md-3">
                                <p><b>จำนวนหลา :</b> {{ $withorders1->sumYard }} <b>หลา</b></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-3">
                                {{-- <p><b>หน้ากว้าง :</b> {{ $withorders1->fabricW }} --}}
                            </div>
                            <div class="col-md-3">
                                <p><b>จำนวนเมตร :</b> {{ $withorders1->sumM }} <b>เมตร</b></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-2">
                                <p><b>หมายเหตุ</b> {{ $withorders1->comment }}</p>
                            </div>
