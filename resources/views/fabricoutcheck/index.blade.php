                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" value="{{ $order[$i]->refId }}">
                        ...
                        <div class="col-12 table-responsive">
                                    ...
                                    @for ($i = 0; $i < $c; $i++)
                                        <tr>
                                            <td> {{ $date = date('d/m/Y', strtotime($allfabricout[$i]->lastCreateDate)) }}
                                                {{-- <br>
                                                {{ $allfabricout[$i]->lastCreateDate }} --}}
                                            </td>
                                            {{-- {{ $date = date('d/m/Y', strtotime($allfabricout[$i]->lastCreateDate)) }} --}}
                                            <td>{{ $allfabricout[$i]->customer }}</td>
                                            <td>{{ $allfabricout[$i]->fabricId }}</td>
                                            ...
                                            <td>
                                                <form method="post"
                                                    ...
                                                    @method('DELETE')
                                                    {{-- urlencode($key); --}}
                                                    <input type="hidden" value="{{ $allfabricout[$i]->refId }}"><br>
                                                    {{-- <input type="text" value="{{ urlencode($allfabricout[$i]->refId) }}"> --}}
                                                    <div style="margin: 0.2rem">
                                                        <button class="btn btn-danger" type="button"
                                                            style="margin: 0.2rem"
                                                            onclick="if(confirm('ต้องการลบหรือไม่?')) { this.form.submit(); }">ลบ</button><br>
                            ...
                            {{-- <table class="table table-bordered table-a" style="width:100%">
                                ...
                                <tbody style="text-align: right;">
                                    ...
                                    @for ($i = 0; $i < $c; $i++)
                                        <tr>
                                            <td> {{ $date = date('d/m/Y', strtotime($allfabricout[$i]->lastCreateDate)) }}<br>
                                                {{ $allfabricout[$i]->lastCreateDate }}
                                            </td>
                                        </tr>
                                    @endfor
