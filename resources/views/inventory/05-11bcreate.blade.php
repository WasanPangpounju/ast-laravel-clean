                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <ul id="supp">
                                    @foreach ($orders as $order)
                                        <li><a
                                                href="javascript:setsupplierFunction('supp', '{{ $order->fabricStructure }}' , '{{ $order->fabricPattern }}');">{{ $order->fabricStructure }}  {{ $order->fabricPattern }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($backdata))
                                    <input type="text" name="fabricPattern" 
                                        class="form-control" id="fabricPattern" placeholder=""
                                        value="{{ $backdata->fabricPattern }}">
                                @else
                                    <input type="text" name="fabricPattern" 
                                        class="form-control" id="fabricPattern" placeholder="ลายผ้า"
                                        value="{{ $fabricPattern }}" required>
                                @endif
