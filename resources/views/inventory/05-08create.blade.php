...
@section('content')
        ...
        <div class="content">
            ...
            <div class="col-md-6">
                {{-- <div class="form-group">
                    ...
                    @else
                        <input type="text" name="fabricStruct" onkeyup="supplierFunction('fabricStruct')"
                            class="form-control" id="fabricStruct" placeholder="โครงสร้างผ้า" value="{{ $fabricStruct }}"
                            required>
                    @endif
    ...
    @endfor
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4" style="position: sticky;top: 20em;">
                    <p>จำนวนรวม : <strong id="sum"></strong> หลา</p>
                    <input type="hidden" id="emp" name="emp" value="{{ Auth::user()->name }}">
                    <div class="form-group">
                        <label for="fabricStruct">โครงสร้างผ้า </label>
                        ...
                        @for ($k = 0; $k < 20; $k++)
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    {{ $j + 1 }} <input type="text" name="sumYard[{{ $j + 1 }}]"
                                        class="input-text" id="sumYard{{ $j + 1 }}" style="width: 50%">
                                </div>
                            </div>
                        @endfor
                    </div>
    ...
    @endfor -->
        ...
        <form action="{{ route('inventory.store') }}" method="post" target="_blank">
            @csrf
            <input type="hidden" name="customerName" value="testttttttttttttttt">
