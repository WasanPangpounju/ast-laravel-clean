                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            @endif --}}
                                ...
                                <div class="form-group">
                                    ...
                                    @if (isset($backdata))
                                        <input type="text" name="fabricId" class="form-control" id="fabricId"
                                            placeholder="" value="{{ $backdata->fabricId }}">
                                    @else
                                        <input type="text" name="fabricId" class="form-control"
                                            id="fabricId" placeholder="ลายผ้า" value="{{ $fabricId }}"
                                            required>
                                    @endif
                                ...
                                @foreach ($customers as $customer)
                                    <li><a
                                            href="javascript:setcustomerFunction('name', '{{ $customer->name }}');">{{ $customer->name }}</a>
                                    </li>
                                @endforeach
                            </ul> --}}
