                            ...
                            <div class="col-md-1">
                                @for ($k = 0; $k < 20; $k++)
                                    <div class="form-group">
                                        ...
                                        <p style="background-color: rgb(255, 238, 0);"> {{ $j + 1 }} <input
                                                type="text" name="sumYard[{{ $j + 1 }}]" class="input-text"
                                                id="sumYard{{ $j + 1 }}"
                                                style="width: 50%;font-size:14pt;font-weight: bold;float:right;"></p>
                                    </div>
                                @endfor
                            </div>
                        @endfor
