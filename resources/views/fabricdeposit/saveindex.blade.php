    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="box-from">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="fabricStruct">วันที่</label>
                                <input class="date form-control" type="text" name="imDate" autocomplete="off">
                ...
                @if (isset($importFabricoutDepo) && count($importFabricoutDepo) > 0)
                <div class="row">
            ...
            {{ $sumStockfabric[0]->sumYardSum }} --}}
                ...
                @elseif(isset($importFabricoutDepo) && count($importFabricoutDepo) < 1)
                    <p>ไม่พบผลการค้นหา</p>
                @else
                    <div class="row">
                        <div class="col-12 table-responsive">
