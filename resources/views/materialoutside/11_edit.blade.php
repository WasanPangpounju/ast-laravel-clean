        ...
        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							@if(isset($backdata))
              <textarea name="comment" class="form-control" id="inputEmail3" placeholder="การนำไปใช้" value="{{ $dataEdit->comment }}"></textarea>
							@else
              <textarea name="comment" class="form-control" id="inputEmail3" placeholder="การนำไปใช้" >{{ $dataEdit->recipient }}</textarea>
							@endif
