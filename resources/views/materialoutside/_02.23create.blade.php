...
@section('content')
 ...
 <div class="content-wrapper">
		...
		<div class="content">
			<div class="box-from">
				<h2 class="title"><i class="fa fa-caret-right"></i> เบิกวัตถุดิบ</h2>

			  <form method="post" action="{{ route('materialoutside.store') }}" id="myForm">
			  						@csrf
...
@else
	<input type="text" name="supplierName" onkeyup="supplierFunction('supplierName')" class="form-control" id="supplierName" placeholder="ชื่อบริษัท" required>
@endif
...
@endforeach
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							@else
							<input type="number" name="box" class="form-control" id="inputEmail3" placeholder="จำนวน">
							@endif
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							@else
								<input type="number" name="sack" class="form-control" id="inputEmail3" placeholder="จำนวน">
							@endif
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
							<input type="number" name="spool" oninput="setCount(this.value , 'yarnSum')" onchange="setCount(this.value , 'yarnSum')" class="form-control" id="spool" placeholder="จำนวนหลอดทั้งหมด (หลอด)" required>
							@endif
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="number" name="yarnSum" oninput="setCount(this.value , 'spool')" onchange="setCount(this.value , 'spool')" class="form-control" id="yarnSum" placeholder="จำนวนด้ายทั้งหมด (ลูก)" required>
							@endif
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="text" name="weight_p_sum" oninput="weightConverter(this.value , 'weight_kg_sum')" onchange="weightConverter(this.value , 'weight_kg_sum')" class="form-control" id="weight_p_sum" placeholder="ปอนด์" required>
							@endif
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="text" name="weight_kg_sum" oninput="weightConverter1(this.value, 'weight_p_sum')" onchange="weightConverter1(this.value , 'weight_p_sum')" class="form-control" id="weight_kg_sum" placeholder=" กิโลกรัม" required>
							@endif
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="text" name="weight_p_package" oninput="weightConverter(this.value , 'weight_kg_package')" onchange="weightConverter(this.value , 'weight_kg_package')" class="form-control" id="weight_p_package" placeholder="ปอนด์" required>
							@endif
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="text" name="weight_kg_package" oninput="weightConverter1(this.value, 'weight_p_package')" onchange="weightConverter1(this.value , 'weight_p_package')" class="form-control" id="weight_kg_package" placeholder=" กิโลกรัม" required>
							@endif
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="text" name="weight_p_net" class="form-control" id="weight_p_net" placeholder="ปอนด์" required>
							@endif
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="text" name="weight_kg_net" class="form-control" id="weight_kg_net" placeholder=" กิโลกรัม" required>
							@endif
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="text" name="average_p" class="form-control" id="average_p" placeholder="ปอนด์" required>
							@endif
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							@else
								<input type="text" name="average_kg"class="form-control" id="average_kg" placeholder=" กิโลกรัม" required>
							@endif
				...
				<div class="row">
					...
					<div class="col-md-9" style="margin-top:10px;">
            			...
            			{{-- <div class="icheck-primary d-inline">
							@if(isset($backdata) && $backdata->packaging5 == 'spool')
								<input type="radio" id="radioPrimary4" name="packaging5" value="all" checked> ทั้งหมด
								@else
								<input type="radio" id="radioPrimary4" name="packaging5" value="all"> ทั้งหมด
							@endif
						</div> --}}
					</div>
				</div><!--row-->
        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="recipient" class="col-txt-1"> ผู้รับวัตถุดิบ</label>
							<div class="col-form">

							@if(isset($backdata))
								<input type="text" name="recipient" class="form-control" id="inputEmail3" placeholder="ผู้รับวัตถุดิบ" value="{{ $backdata->recipient }}" required>
							@else
								<input type="text" name="recipient" class="form-control" id="inputEmail3" placeholder="ผู้รับวัตถุดิบ" required>
							@endif
        ...
        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="comment" class="col-txt-1"> การนำไปใช้</label>
							<div class="col-form">

							@if(isset($backdata))
              <textarea name="comment" class="form-control" id="inputEmail3" placeholder="การนำไปใช้" >{{ $backdata->comment }}</textarea>
							@else
              <textarea name="comment" class="form-control" id="inputEmail3" placeholder="การนำไปใช้" ></textarea>
							@endif
				...
				<button name="submit" value="cleanForm" class="btn b_order clean"><img src="<?php echo asset('assets/images/xmark-solid.png'); ?>" width="15">  เคลียร์ข้อมูล</button> 
					<button name="submit" value="checkdata" class="btn b_save"><img src="<?php echo asset('assets/images/circle-check-solid.png'); ?>" width="17"> ตรวจสอบ</button>
				</div>
