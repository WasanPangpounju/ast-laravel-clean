        ...
        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							@if(isset($backdata))
								<input type="text" name="recipient" class="form-control" id="inputEmail3" placeholder="ผู้รับวัตถุดิบ" value="{{ $backdata->pallet }}">
							@else
								<input type="text" name="recipient" class="form-control" id="inputEmail3" placeholder="ผู้รับวัตถุดิบ">
							@endif
        ...
        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							@if(isset($backdata))
              <textarea name="comment" class="form-control" id="inputEmail3" placeholder="การนำไปใช้" value="{{ $backdata->pallet }}"></textarea>
							@else
