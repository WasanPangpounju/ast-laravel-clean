...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="yarnType" onkeyup="yarntypeFunction('yarnType')" class="form-control"
                            id="yarnType" placeholder="ชนิดด้าย" required>
                    @endif

                    <ul class="yarntypeUL">
                        @foreach ($stockYarns as $key => $yarntype)
                            <li><a href="javascript:setyarntypeFunction('', '{{ $key }}');">{{ $key }}</a>
                            </li>
                        @endforeach
                    </ul>
        ...
        <div class="row">
			...
			<div class="col-md-1">
                <div class="form-group">
                    <select name="pallet_type" class="form-control" id="typetag">
			...
			<div class="col-md-1">
                <div class="form-group">
                    <select name="sack_type" class="form-control" id="typetag">
        ...
        <div class="row">
			<div class="col-md-4 align-items-end">
                <div class="form-group">
                    ...
                    @if (isset($backdata))
                        <input type="number" name="partition" class="form-control" id=""
                            placeholder="จำนวนกระดาษกั้น" value="{{ $backdata->partition  }}" >
                    @else
                        <input type="number" name="partition" class="form-control" id=""
            ...
            <div class="col-md-1 d-flex align-items-end">
                <div class="form-group">
                    <label for=""></label>
                    <select name="spool_type" class="form-control" id="typetag">
...
{{--            <div class="col-md-1 d-flex align-items-end">
                <div class="form-group">
                    <select name="typetag_spool_cylinder" class="form-control" id="typetag">
        ...
        <div class="row">
            ...
            <div class="col-md-9" style="margin-top:10px;">
                ...
                <div class="icheck-primary d-inline">
                    @if (isset($backdata) && $backdata->packaging5 == 'pallet')
                    ...
                    <div class="col-form">
                        @if (isset($backdata))
                            <input type="text" name="recipient" class="form-control" id="inputEmail3"
                                placeholder="ผู้รับวัตถุดิบ" value="{{ $backdata->recipient }}" required>
                        @else
                            <input type="text" name="recipient" class="form-control" id="inputEmail3"
                                placeholder="ผู้รับวัตถุดิบ" required>
                        @endif
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-form">
                        @if (isset($backdata))
                            <textarea name="paymentComment" class="form-control" id="inputEmail3" placeholder="paymentComment">{{ $backdata->paymentComment }}</textarea>
                        @else
                            <textarea name="paymentComment" class="form-control" id="inputEmail3" placeholder="paymentComment"></textarea>
                        @endif
