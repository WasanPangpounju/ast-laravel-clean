...
{{--            <div class="col-md-1 d-flex align-items-end">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="comment2" class="col-txt-1">หมายเหตุ</label>
                    <div class="col-form">
                        @if (isset($backdata))
                            <textarea name="comment2" class="form-control" id="inputEmail3" placeholder="หมายเหตุ">{{ $backdata->comment2 }}</textarea>
                        @else
                            <textarea name="comment2" class="form-control" id="inputEmail3" placeholder="หมายเหตุ"></textarea>
                        @endif
