 ...
 <div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<h1 class="m-0"><i class="nav-icon fas fa fa-arrow-circle-right"></i> แก้ไขรายการเบิกวัตถุดิบออกภายนอก</h1>
				</div>
			</div>
		</div>
		<!-- Main content -->
...
@endforeach
        ...
        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							@if(isset($backdata))
								<input type="text" name="recipient" class="form-control" id="inputEmail3" placeholder="ผู้รับวัตถุดิบ" value="{{ $dataEdit->recipient }}">
							@else
								<input type="text" name="recipient" class="form-control" id="inputEmail3" placeholder="ผู้รับวัตถุดิบ" value="{{ $dataEdit->recipient }}">
							@endif
        ...
        <div class="row">
              ...
              <textarea name="comment" class="form-control" id="inputEmail3" placeholder="การนำไปใช้" >{{ $dataEdit->comment }}</textarea>
				...
				<div class="line_btn">
				<button name="submit" value="cleanForm" class="btn b_order clean"><img src="<?php echo asset('assets/images/xmark-solid.png'); ?>" width="15">  ยกเลิก</button> 
