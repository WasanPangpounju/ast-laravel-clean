        ...
        <div class="content">
            <div class="box-from">
                            ...
                            <table class="table table-bordered table-a">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td>{{ $imdata->recipient }}</td>
									</tr>
									<tr>
										<td>การนำไปใช้</td>
										<td>{{ $imdata->comment }}</td>
									</tr>
                                    <tr>
										<td>หมายเหตุ</td>
										<td>{{ $imdata->paymentComment }}</td>
									</tr>
                ...
                <form method="post" action="{{ route('materialoutside.store') }}">
                    ...
                    <input type="hidden" id="partition" name="partition" value="{{ $imdata->partition }}">

                    <input type="hidden" id="pallet_type" name="pallet_type" value="{{ $imdata->pallet_type }}">
                    <input type="hidden" id="box_type" name="box_type" value="{{ $imdata->box_type }}">
                    <input type="hidden" id="sack_type" name="sack_type" value="{{ $imdata->sack_type }}">
                    <input type="hidden" id="spool_type" name="spool_type" value="{{ $imdata->spool_type }}">
                    ...
                    <input type="hidden" id="packaging5" name="packaging5" value="{{ $imdata->packaging5 }}">

					<input type="hidden" id="recipient" name="recipient" value="{{ $imdata->recipient }}">
                    <input type="hidden" id="comment" name="comment" value="{{ $imdata->comment }}">

                    <input type="hidden" id="paymentComment" name="paymentComment" value="{{ $imdata->paymentComment }}">
