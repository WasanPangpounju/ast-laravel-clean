	...
	<div class="content-wrapper">
		...
		<div class="content">
			<div class="box-from">
			  ...
			  <form method="post" action="{{ route('materialstore.update') }}">
			  						@csrf
				  ...
				  <div class="row" id="listwithdraw">
					  ...
					  <div class="col-md-3">
						   <div class="form-group">
							...
							<input type="text" name ="supplierName[0]" onkeyup="supplierFunction('supId')" class="form-control" id="supId" placeholder="บริษัท" value="{{ $dataEdit->supplierName }}" required >
...
?>
					...
					@endforeach
					  ...
					  <div class="col-md-3">
						   <div class="form-group">
							...
							<input type="text" name="yarnType[0]" onkeyup="yarntypeFunction('yarntype')" class="form-control" id="yarntype" placeholder="ชนิดด้าย" value="{{ $dataEdit->yarnType }}" required >
					...
					@endforeach
					  ...
					  <div class="col-md-3">
						   <div class="form-group">
							...
							<input type="text" name="spool[0]" class="form-control" id="spool" placeholder="จำนวน" value="{{ $dataEdit->spool }}" required >
						   </div>
					  </div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group date" id="reservationdate" data-target-input="nearest">
								<input type="text" name="createDate[0]" class="form-control datetimepicker-input" data-target="#reservationdate" value="{{ $dataEdit->createDate }}" />
          ...
          <div class="col-md-2">
						<div class="form-group">
							...
							@if(isset($dataEdit))
								<input type="text" name="weight_p_net" class="form-control" id="lot" placeholder="ล็อตที่" value="{{ $dataEdit->weight_p_net }}">
							@else
								<input type="text" name="weight_p_net" class="form-control" id="lot" placeholder="ล็อตที่">
							@endif
          ...
          <div class="col-md-2">
						<div class="form-group">
							...
							@if(isset($dataEdit))
								<input type="text" name="lot" class="form-control" id="lot" placeholder="ล็อตที่" value="{{ $dataEdit->weight_kg_net }}">
							@else
								<input type="text" name="lot" class="form-control" id="lot" placeholder="ล็อตที่">
							@endif
          ...
          <div class="col-md-2">
						<div class="form-group">
							...
							@if(isset($dataEdit))
								<input type="text" name="lot" class="form-control" id="lot" placeholder="ล็อตที่" value="{{ $dataEdit->average_p }}">
							@else
								<input type="text" name="lot" class="form-control" id="lot" placeholder="ล็อตที่">
							@endif
          ...
          <div class="col-md-2">
						<div class="form-group">
							...
							@if(isset($dataEdit))
								<input type="text" name="lot" class="form-control" id="lot" placeholder="ล็อตที่" value="{{ $dataEdit->average_kg }}">
							@else
								<input type="text" name="lot" class="form-control" id="lot" placeholder="ล็อตที่">
							@endif
