		...
		<div class="content">
            ...
            <table class="table table-striped" id="dynamicAddRemove">
                    ...
                    <tbody>
						...
						<input type="hidden" name="coordinator[{{ $i }} ][coID]" value="{{ $cuscoorData->id}}">
					<tr>
						<td><input type="text" name="coordinator[{{ $i }}][name]" placeholder="ผู้ประสานงาน" class="form-control" value="<?php print($cuscoorData->name); ?>" required />
						</td>
						<td><input type="text" name="coordinator[{{ $i }}][jobTitle]" placeholder="ตำแหน่ง" class="form-control" value="<?php print($cuscoorData->jobTitle); ?>"/>
						</td>
						<td><input type="text" name="coordinator[{{ $i }}][tel]" placeholder="เบอร์โทรศัพท์" class="form-control" value="<?php print($cuscoorData->tel); ?>"/>
						</td>
