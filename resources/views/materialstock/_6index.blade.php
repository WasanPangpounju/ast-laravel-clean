...
<tr>
                                            <td>{{ $item->supplierName }}</td> <!--ชื่อบริษัท-->
                                            <td>{{ $tmp_spool }}</td> <!--จำนวนด้ายรวม-->
                                            <td>{{ $tmp_sumweight_p_net }} </td> <!--น้ำหนักรวม p -->
                                            <td>{{ $tmp_sumweight_kg_net }}</td> <!--น้ำหนักรวม kg-->
                                            <td>{{ number_format($item->average_p ,4); }} </td> <!--น้ำหนักรวมเฉลี่ย p -->
                                            <td>{{ number_format($item->average_kg ,4); }} </td> <!--น้ำหนักรวมเฉลี่ย kg-->
                                            </tr>
@break
                                            @endif
                                        @endforeach
...
<tr>
                                            <td>{{ $item->supplierName }}</td> <!--ชื่อบริษัท-->
                                            <td>{{ $item->sumspool }}</td> <!--จำนวนด้ายรวม-->
                                            <td>{{ number_format($item->sumweight_p_net , 4); }} </td> <!--น้ำหนักรวม p -->
                                            <td>{{ number_format($item->sumweight_kg_net ,4); }}</td> <!--น้ำหนักรวม kg-->
                                            <td>{{ number_format($item->average_p ,4); }} </td> <!--น้ำหนักรวมเฉลี่ย p -->
                                            <td>{{ number_format($item->average_kg ,4); }} </td> <!--น้ำหนักรวมเฉลี่ย kg-->
                                            </tr>
