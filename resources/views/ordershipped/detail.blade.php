            ...
            <div class="content">
                <div class="box-from">
                    ...
                    <div class="row">
                        <div class="col-md-2"></div>
                        <div class="col-md-3">
                            <p><b>พนักงานคนที่ส่ง :</b> {{ $imdata->staff }}
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-2"></div>
                        <div class="col-md-3">
                            <p><b>ชื่อผู้รับ :</b> {{ $imdata->exceptName }}
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2"></div>
                ...
                <div class="purchase_order_signature">
                    <div class="row">
                        ...
                        <div class="col-md-3" style="margin-left:13em;">
                            <form action="{{ route('ordershipped.store', $imdata->refId) }}" method="post">
                                @csrf
                                ...
                                <input type="hidden" name="staff" value="{{ $imdata->staff }}">
                                <input type="hidden" name="exceptName" value="{{ $imdata->exceptName }}">
