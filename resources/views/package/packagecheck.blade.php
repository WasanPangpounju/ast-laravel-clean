...
@section('content')
    ...
    <div class="content-wrapper">
                        ...
                        <div class="col-6 table-responsive">
                            <table class="table table-bordered table-a">
                                ...
                                <tbody>
                                    <tr>
                                        <td>คืน</td>
                                        <td>{{ $packdata->spool_paper }}</td>
                                        <td>{{ $packdata->spool_plastic }}</td>
                                        <td>{{ $packdata->spoolC_paper }}</td>
                                        <td>{{ $packdata->spoolC_plastic }}</td>
                                        <td>{{ $packdata->sack }}</td>
                                        <td>{{ $packdata->box }}</td>
                                        <td>{{ $packdata->pallet_wood }}</td>
                                        <td>{{ $packdata->pallet_steel }}</td>
                                        <td>{{ $packdata->partition }}</td>
                                    </tr>
                                    <tr>
                                        <td>คืน</td>
                                        <td>{{ $packdata->createDate }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        <!--row-->
        <div class="line_btn">
            <input type="hidden" name="createDate" value="{{ $packdata->createDate }}">
            <input type="hidden" name="supplier_name" value="{{ $packdata->supplier_name }}">
            <input type="hidden" name="spool_paper" value="{{ $packdata->spool_paper }}">
            <input type="hidden" name="spool_plastic" value="{{ $packdata->spool_plastic }}">
            <input type="hidden" name="spoolC_paper" value="{{ $packdata->spoolC_paper }}">
            <input type="hidden" name="spoolC_plastic" value="{{ $packdata->spoolC_plastic }}">
            <input type="hidden" name="sack" value="{{ $packdata->sack }}">
            <input type="hidden" name="box" value="{{ $packdata->box }}">
            <input type="hidden" name="pallet_wood" value="{{ $packdata->pallet_wood }}">
            <input type="hidden" name="pallet_steel" value="{{ $packdata->pallet_steel }}">
            <input type="hidden" name="partition" value="{{ $packdata->partition }}">
