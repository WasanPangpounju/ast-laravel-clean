                            ...
                            <table class="table table-bordered table-a" style="width:150%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $spool_paperRet[0]->spoolsum - $sumReturnPackageSuccess[0]->spool_paper }}
                                        </td>
                                        <td>{{ $spool_plasticRet[0]->spoolsum - $sumReturnPackageSuccess[0]->spool_plastic }}
                                        </td>
                                        <td>{{ $spoolC_paperRet[0]->spoolsum - $sumReturnPackageSuccess[0]->spoolC_paper }}
                                        </td>
                                        <td>{{ $spoolC_plasticRet[0]->spoolsum - $sumReturnPackageSuccess[0]->spoolC_plastic }}
                                        </td>
                                        <td>{{ $returnPackage[0]->spoolsum -
                                            $spool_plasticRet[0]->spoolsum -
                                            $spool_paperRet[0]->spoolsum -
                                        ...
                                        <td>{{ $returnPackage[0]->sacksum - $sumReturnPackageSuccess[0]->sacksum }}</td>
                                        <td>{{ $returnPackage[0]->boxsum - $sumReturnPackageSuccess[0]->boxsum }}</td>
                                        <td>{{ $palletWoodRet[0]->palletsum - $sumReturnPackageSuccess[0]->pallet_wood }}
                                        </td>
                                        <td>{{ $palletSteelRet[0]->palletsum - $sumReturnPackageSuccess[0]->pallet_steel }}
                                        </td>
                                        <td>{{ $returnPackage[0]->palletsum - $palletSteelRet[0]->palletsum - $palletWoodRet[0]->palletsum - $sumReturnPackageSuccess[0]->palletsum }}
                                        </td>
                                        <td>{{ $partitionRet - $sumReturnPackageSuccess[0]->partitionsum }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
