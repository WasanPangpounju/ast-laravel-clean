                            ...
                            <table class="table table-bordered table-a">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><?php echo  $package_data[0]->spoolsum; ?></td>
                                        <td><?php echo  $package_data[0]->sacksum; ?></td>
                                        <td><?php echo  $package_data[0]->boxsum; ?></td>
                                        <td></td>
                                        <td></td>
                                        <td><?php echo  $package_data[0]->palletsum; ?></td>
                                    </tr>
                                    <tr>
                                        <td>คืนแล้ว</td>
                                        <td>2</td>
