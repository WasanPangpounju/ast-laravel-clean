		...
		<div class="content">
				...
				?>
						  ...
						  <table class="table table-bordered table-a">
							...
							<tbody>
								...
								<tr>
									...
									?>
									<td>{{ $dataEdit[0]->supplier_name }}</td>
								...
								<tr>
								<form method="POST" action="{{ route('package.htrstore', $dataEdit[0]->supplier_name) }}">
									@csrf
									@method('DELETE')
									<td>
										<!-- <input type="hidden" name="supplier_name" class="form-control" value="{{ $dataEdit[0]->supplier_name }}"> -->
									</td>
									<td><input type="text" name="spool" class="form-control"  placeholder="lot"></td>
									...
									<td><input type="text" name="pallet" class="form-control"  placeholder="หลอด"></td>
				   ...
				   <div class="line_btn">
				    	...
				    	<button class="btn b_save" type="submit"><img src="assets/images/circle-check-solid.png" width="17"> คืนบรรจุภัณฑ์</button>
			       </div>
				</form><!-- end form -->
            	</div><!-- inner_content -->
		</div><!--content-->
