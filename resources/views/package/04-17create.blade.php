...
- $spoolC_paperImp[0]->spoolsum 
                                        ...
                                        <td>{{ $sumPackage[0]->palletsum - $palletSteelImp[0]->palletsum - $palletWoodImp[0]->palletsum }}</td>
                                        <td>{{ $partitionImp }}</td>
                                    </tr>
                                    <tr>
                                        <td>ต้องส่งคืน</td>
...
- $spoolC_paperRet[0]->spoolsum 
                                        ...
                                        <td>{{ $returnPackage[0]->palletsum - $palletSteelRet[0]->palletsum - $palletWoodRet[0]->palletsum }}</td>
                                        <td>{{ $partitionRet }}</td>
                                    </tr>
                                    <tr>
                                        <td>คืนแล้ว</td>
