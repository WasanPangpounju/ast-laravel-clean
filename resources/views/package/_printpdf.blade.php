			...
			<div class="box-from">
				...
				?>
					   ...
					   <div class="col-3">
						  ...
						  <table class="table table-bordered table-a">
							...
							<tbody>
								<?php 
								$c1 = 0; 
								print_r($lastCreatedData);
								?>
								@foreach($lastCreatedData as $packageList)
									<tr>
									<td>{{ $packageList->emp }}</td>
									...
									<td>
										<div style="  display: flex;justify-content: center;align-items: center;">
												<button class="btn b_order" type="button" ><a href="{{ route('package.edit',$packageList->supplier_name)}}">คืนบรรจุภัณฑ์</a></button>
										</div>
									</td>
								</tr>
								@endforeach
				   ...
				   <div class="line_btn">
				    	...
				    	<button class="btn b_save"><img src="assets/images/circle-check-solid.png" width="17"> ตรวจนับวัตถุดิบ</button>
			       </div>
