...
print(' <b>หมายเหตุ : </b>'. $comment);
                            ...
                            <div class="form-group">
                                ...
                                <ul id="supp">
                                    @foreach ($stockFabricStruct as $stockFS)
                                        <li><a
                                                href="javascript:setsupplierFunction('supp', '{{ $stockFS->fabricStruct }}' , '{{ $stockFS->fabricPattern }}' , '{{ $stockFS->fabricW }}');">{{ $stockFS->fabricStruct }} {{ $stockFS->fabricPattern }} หน้ากว้าง {{ $stockFS->fabricW }} '</a>
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="form-group">
                                ...
                                @else
                                    <input type="text" name="fabricW" class="form-control" id="fabricW"placeholder="หน้ากว้าง" value=""
                                        required>
                                @endif
