...
print(' <b>หมายเหตุ : </b>'. $comment .'<br>');
    ...
    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                @else
                                    <input type="text" name="fabricStructReplace" class="form-control"
                                        id="fabricStructReplace" placeholder="แทนโครงสร้างผ้า" value="">
                                @endif

                            </div>
                            <div class="form-group">
                                <label for="customerReplace">แทนผู้ส่ง</label>
                                @if (isset($backdata))
                                    <input type="text" name="customerReplace" class="form-control"
                                        id="customerReplace" placeholder="แทนผู้ส่ง" value="{{ $backdata->comment }}">
                                @else
                                    <input type="text" name="customerReplace" class="form-control"
                                        id="customerReplace" placeholder="แทนผู้ส่ง" value="">
                                @endif

                            </div>
                            <div class="form-group">
                                <label for="vatType">แทนผู้ส่ง</label>
                                @if (isset($backdata))
                                    <select name="vatType" class="form-control" id="vatType">
                                        <option value="volvo" selected>บิล มี</option>
                                        <option value="saab">บิล ไม่เอา</option>
                                    </select>
                                @else
                                    <select name="vatType" class="form-control" id="vatType">
                                        <option value="volvo" selected>บิล มี</option>
