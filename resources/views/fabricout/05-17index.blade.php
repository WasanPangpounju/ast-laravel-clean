    ...
    <div class="content-wrapper">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">รายการสินค้าคงคลัง</li>
            </ol>
        </div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <h1 class="m-0"><i class="nav-icon fas fa fa-arrow-circle-right"></i> รายการสินค้าคงคลัง</h1>
                </div>
            </div>
        </div>
        <!-- Main content -->
        <div class="content">
            <div class="box-from">
                <h2 class="title"><i class="fa fa-caret-right"></i> รายการผ้าผลิตแล้วในสต๊อก</h2>
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                                        ...
                                        <td>
                                            <form action="{{ route('fabricout.store') }}" method="post" target="_blank">
                                                ...
                                                <button type="submit" class="btn b_order" name="submit"
                                                    value="submitfabricout">สั่งใบส่งสินค้า</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endfor
