...
print(' <b>หมายเหตุ : </b>'. $comment);
                        ...
                        <input type="text" name="orderId" class="form-control" value="<?php print $order_id; ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="customerName" class="form-control" id="myInput" onkeyup="myFunction()"
                            placeholder="ผู้สั่ง" value="{{ $customer_name }}" required>
                    @endif


                    <ul id="myUL">
                        @foreach ($customers as $customer)
                            <li><a href="javascript:setcustomerFunction('{{ $customer->name }}');">{{ $customer->name }}</a>
                            </li>
                        @endforeach
                    </ul>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @else
                        <input type="text" name="fabricStruct" onkeyup="supplierFunction('fabricStruct')" 
                        class="form-control" id="fabricStruct"
                            placeholder="โครงสร้างผ้า" value="{{ $fabric_struct }}" required>
                    @endif
        ...
        @for ($i = 0; $i < 20; $i++)
            <div class="row">
                @for ($j = 0; $j < 5; $j++)
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="fold{{ $c + $i * 5 + $j + 1 }}">พับที่ {{ $c + $i * 5 + $j + 1 }}</label>
                            <input type="hidden" name="fold[{{ $c + $i * 5 + $j + 1 }}]" class="form-control"
                                id="fold{{ $c + $i * 5 + $j + 1 }}" value="{{ $c + $i * 5 + $j + 1 }}" required>
                            <label for="sumYard{{ $c + $i * 5 + $j + 1 }}"> จำนวนหลา </label>
                            <input type="text" name="sumYard[{{ $c + $i * 5 + $j + 1 }}]" class="input-text"
                                id="sumYard{{ $c + $i * 5 + $j + 1 }}" placeholder="จำนวนหลา">
                        </div>
                    </div>
                @endfor
            </div>
