                ...
                @for ($i = 0; $i < 10; $i++)
                    <div class="row">
                        @for ($j = 0; $j < 10; $j++)
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="fold{{ $c + $i * 10 + $j + $c }}">พับที่ {{ $c + $i * 10 + $j + $c }}</label>
                                    <input type="hidden" name="fold[{{ $c + $i * 10 + $j  }}]" class="form-control"
...
<div class="content">
    <div class="box-from">
        @for ($i = 0; $i < 10; $i++) <!-- loop for 10 rows -->
            <div class="row">
                @for ($j = 0; $j < 10; $j++) <!-- loop for 10 columns -->
                    @php
