    ...
    <div class="content-wrapper">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">ตรวจสอบการจัดส่ง</li>
            </ol>
        </div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <h1 class="m-0"><i class="nav-icon fas fa fa-arrow-circle-right"></i> ตรวจสอบการจัดส่ง</h1>
                </div>
            </div>
        </div>
        <!-- Main content -->
        <div class="content">
            <div class="box-from">
                <h2 class="title"><i class="fa fa-caret-right"></i> ตรวจสอบการจัดส่ง</h2>
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                                            ...
                                            <form action="{{ route('fabricout.store') }}" method="post" target="_blank">
                                                ...
                                                <input type="hidden" name="fabricout_no"
                                                    ...
                                                    <button type="submit" class="btn b_order" name="submit"
                                                        style="width: 5rem;margin: 0.2rem;font-size: 0.8rem" value="submitfabricout">สั่งใบส่ง</button>
                                            </form>
                                        </td>
                                        <td>
                                            <form method="POST"
