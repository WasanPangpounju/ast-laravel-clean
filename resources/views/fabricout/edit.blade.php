        ...
        <div class="content">
            <div class="box-from">
                ...
                <form method="post" action="{{ route('fabricout.store') }}" id="myForm">
                    ...
                    <input type="hidden" id="vatNo1" name="vatNo" value="{{ $vatNo }}">
                    <input type="hidden" id="vatType1" name="vatType" value="{{ $vatType }}">
                        ...
                        print(' <b>หมายเหตุ : </b>'. $comment .'<br>');
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($FabricOutEdit2 as $FOutEdit)
                                        {{-- @if (isset($backdata))
                            ...
                            @endif --}}
                                        <input class="date form-control" type="text" name="dt" value="{{$FOutEdit->createDate}}"
                                            autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                        <input type="text" name="fabricStruct"
                                            onkeyup="supplierFunction('fabricStruct')" class="form-control"
                                            id="fabricStruct" placeholder="โครงสร้างผ้า" value="{{$FOutEdit->fabricStruct}}"
                                            required>
                                    @endif
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            @else
                                                <input type="text" name="fabricPattern" class="form-control"
                                                    id="fabricPattern" placeholder="ลายผ้า" value="{{$FOutEdit->fabricPattern}}"
                                                    required>
                                            @endif
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            @else
                                                <input type="text" name="fabricW" class="form-control"
                                                    id="fabricW"placeholder="หน้ากว้าง" value="{{$FOutEdit->fabricW}}"
                                                    required>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                        <input type="text" name="customerName" class="form-control" id="myInput"
                                            onkeyup="myFunction()" placeholder="ผู้สั่ง" value="{{$FOutEdit->customerName}}"
                                            required>
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                        <input type="text" name="receiveName" class="form-control" id="receiveName"
                                            placeholder="ผู้รับ" value="{{$FOutEdit->receiveName}}" required>
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                        <input type="text" name="fabricStructReplace" class="form-control"
                                            id="fabricStructReplace" placeholder="แทนโครงสร้างผ้า"
                                            value="{{$FOutEdit->fabricStructReplace}}">
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    @else
                                        <input type="text" name="customerReplace" class="form-control"
                                            id="customerReplace" placeholder="แทนผู้สั่งซื้อ"
                                            value="{{$FOutEdit->customerReplace}}">
                                    @endif
