...
print(' <b>หมายเหตุ : </b>'. $comment .'<br>');
    ...
    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                @else
                                    <input type="text" name="fabricStructReplace" class="form-control"
                                        id="fabricStructReplace" placeholder="แทนโครงสร้างผ้า" value="{{ $fabricStructReplace }}">
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($backdata))
                                    <input type="text" name="customerReplace" class="form-control"
                                        id="customerReplace" placeholder="แทนผู้สั่งซื้อ" value="{{ $backdata->customerReplace }}">
                                @else
                                    <input type="text" name="customerReplace" class="form-control"
                                        id="customerReplace" placeholder="แทนผู้สั่งซื้อ" value="{{ $customerReplace }}">
                                @endif
