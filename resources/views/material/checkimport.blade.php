...
<input type="hidden" id="" name="typetag_pallet" value="{{ $imdata->typetag_pallet }}">
<input type="hidden" id="" name="typetag_box" value="{{ $imdata->typetag_box }}">
<input type="hidden" id="" name="typetag_sack" value="{{ $imdata->typetag_sack }}">
<input type="hidden" id="" name="typetag_spool" value="{{ $imdata->typetag_spool }}">
<input type="hidden" id="" name="paper_bar" value="{{ $imdata->paper_bar }}">
