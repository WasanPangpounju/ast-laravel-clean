    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="box-from">
                ...
                <form method="post" action="{{ route('material.store') }}" id="myForm">
                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($backdata))
                                    <input type="text" name="importStatus" class="form-control" id="importStatus"
                                        placeholder="เลขที่ใบส่งสินค้า" value="{{ $backdata->importStatus }}">
                                @else
                                    <input type="text" name="importStatus" class="form-control" id="importStatus"
        ...
        <div class="row">
            <div class="col-md-4 align-items-end">
                <div class="form-group">
                    ...
                    @if (isset($backdata))
                        <input type="number" name="paper_bar" class="form-control" id="spool"
                            placeholder="จำนวนกระดาษกั้น" value="{{ $backdata->paper_bar }}" required>
                    @else
                        <input type="number" name="paper_bar" class="form-control" id="spool"
