    ...
    <button  type="submit" class="btn btn-etc"> <i class="fas fa-folder"></i> ดูข้อมูลนำเข้าวัตถุดิบทั้งหมด</button>
                    ...
                    @if (isset($importmaterial) && count($importmaterial) > 0)
                        @if ($select_search == 'importId')
                            <h2>รายการนำเข้าวัตถุดิบ {{ $searchInput }} </h2>
                                        ...
                                        <table class="table table-bordered table-a">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($importmaterial as $impo)
                                                    <tr>
                                                        <td rowspan=“10”>{{ $date = date('d/m/Y', strtotime($impo->createDate)) }}</td>
                                                        ...
                                                        <td>
                                                            <form method="POST"
                                                                action="{{ route('material.destroy', $impo->id) }}">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div
                                                                    ...
                                                                    <button class="btn b_order" type="button"><a
                                                                            href="{{ route('material.edit', $impo->id) }}">แก้ไข</a></button>
                                                                </div>
                                                            </form>
                                                        </td>
                                                    </tr>
                        ...
                        @elseif($select_search == 'yarnType')
                            <h2>รายการนำเข้าวัตถุดิบด้าย {{ $searchInput }} </h2>
                        ...
                        @elseif($select_search == 'imDate')
                            <h2>รายการนำเข้าวัตถุดิบวันที่ {{ $searchInput }}</h2>
